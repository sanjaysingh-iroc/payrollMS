...
public class GoalKRATargetDashboard extends ActionSupport implements ServletRequestAware, IStatements {
...
//		strSessionUserType = (String) session.getAttribute(USERTYPE);
		...
		request.setAttribute(PAGE, "/jsp/performance/GoalKRATargetDashboard.jsp");
