...
public class ReviewDiscussionDashboard extends ActionSupport implements ServletRequestAware, IStatements {
...
//		strSessionUserType = (String) session.getAttribute(USERTYPE);
		...
		request.setAttribute(PAGE, "/jsp/performance/ReviewDiscussionDashboard.jsp");
		request.setAttribute(TITLE, "One on One Discussion");	
