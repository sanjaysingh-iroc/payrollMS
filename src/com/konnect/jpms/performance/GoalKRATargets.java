...
public class GoalKRATargets implements ServletRequestAware, IStatements {
	...
	public String execute() {
		...
		if (CF == null) 
			return "login";
		request.setAttribute(PAGE, "/jsp/performance/GoalKRATargets.jsp");
		...
		if((strBaseUserType!=null && !strBaseUserType.equalsIgnoreCase(MANAGER) && !strBaseUserType.equalsIgnoreCase(ADMIN) 
...
//		System.out.println("getAlertID() ===>> " + getAlertID());
