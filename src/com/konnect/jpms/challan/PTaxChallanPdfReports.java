...
public class PTaxChallanPdfReports implements ServletRequestAware,ServletResponseAware, IStatements {
	...
	//		System.out.println("pst====>"+pst);
			...
			sb.append(" and emp_id in (select emp_id from employee_official_details where  org_id=?) group by paid_date, challan_no");
			...
			for(int i=0;i<monthList.size();i++){
				...
				pst = con.prepareStatement("select sum(amount) as total from payroll_generation where financial_year_from_date=?" +
						" and financial_year_to_date=? and month=? and is_paid=true and salary_head_id=? and emp_id in (select emp_id from employee_official_details where  org_id=?)");
				pst.setDate(1, uF.getDateFormat(strFinancialYearStart, DATE_FORMAT));		
				pst.setDate(2, uF.getDateFormat(strFinancialYearEnd, DATE_FORMAT));
...
//			double totalamount=(Integer)request.getAttribute("totalamount");
		...
		"<tr><td><font size=\"1\">2.&nbsp;&nbsp;Name of the Employer :</font></td><td><font size=\"1\"><b>"+uF.showData(hmOrg.get("ORG_NAME"), "")+"</b></font></td><td></td></tr>" +
		"<tr><td valign=\"top\"><font size=\"1\">3.&nbsp;&nbsp;Address : </font></td><td><font size=\"1\"><b>"+uF.showData(hmOrg.get("ORG_ADDRESS"), "")+"</b></font></td><td></td></tr>" +
		...
		String tbl9 = "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td align=\"left\"><font size=\"1\">Place :&nbsp;&nbsp;&nbsp;&nbsp;</font></td><td></td><td><font size=\"1\">Signature :<br/>(Employer)&nbsp;&nbsp;&nbsp;&nbsp;</font></td></tr>" +
