...
public class TeamStructure extends ActionSupport implements ServletRequestAware, IStatements {
	...
	public String execute() throws Exception {
		...
		request.setAttribute(TITLE, "Team Structure");
		request.setAttribute(PAGE, "/jsp/employee/TeamStructure.jsp");
		...
		sbpageTitleNaviTrail.append("<li><i class=\"fa fa-group\"></i><a href=\"TeamStructure.action\" style=\"color: #3c8dbc;\"> Team Structure</a></li>");
