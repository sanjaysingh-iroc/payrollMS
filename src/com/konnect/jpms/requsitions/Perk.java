...
public class Perk extends ActionSupport implements ServletRequestAware, IStatements {
	...
	public String execute() throws Exception {
		...
		request.setAttribute(TITLE, "Perk");
		request.setAttribute(PAGE, "/jsp/requisitions/Perk.jsp");
