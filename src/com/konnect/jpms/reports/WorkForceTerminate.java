...
import com.konnect.jpms.export.*;
import com.konnect.jpms.charts.*;
import com.opensymphony.xwork2.ActionSupport;

public class WorkForceTerminate extends ActionSupport implements ServletRequestAware, IStatements {
	...
	private static Logger log = Logger.getLogger(WorkForceTerminate.class);
	...
	public String execute() throws Exception {
		...
		if(strUserType!=null && !strUserType.equalsIgnoreCase(ADMIN) 
			...
			request.setAttribute(PAGE, PWorkForceTerminate);
			viewPayCycle(strP);
		}
...
//					alInnerDates.add(dt2);
			...
			System.out.println("alInnerDates====>"+alInnerDates);
			...
			for (int i = 0; i < alInnerDates.size();) {
				...
				if(strUserType!=null ){ 
					...
					if(strP!=null && strP.equalsIgnoreCase("WLH")){
						pst = con.prepareStatement(selectWorkForceTerminateR3_E);
						pst.setDate(1, uF.getDateFormat(strD1, DATE_FORMAT));
						pst.setDate(2, uF.getDateFormat(strD2, DATE_FORMAT));
					}else if(strP!=null && strP.equalsIgnoreCase("DH")){
						pst = con.prepareStatement(selectWorkForceTerminateR5_E);
						pst.setDate(1, uF.getDateFormat(strD1, DATE_FORMAT));
						pst.setDate(2, uF.getDateFormat(strD2, DATE_FORMAT));
					}else if(strP!=null && (strP.equalsIgnoreCase("SH"))){
						...
						pst = con.prepareStatement(selectWorkForceTerminateR4_E);
						pst.setDate(1, uF.getDateFormat(strD1, DATE_FORMAT));
						pst.setDate(2, uF.getDateFormat(strD2, DATE_FORMAT));
					}else{
						pst = con.prepareStatement(selectWorkForceTerminateR3_E);
