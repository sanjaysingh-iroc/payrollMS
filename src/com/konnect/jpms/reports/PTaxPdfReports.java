...
public class PTaxPdfReports extends ActionSupport implements ServletRequestAware,ServletResponseAware, IStatements {
			...
			if(uF.parseToInt(getF_strWLocation())>-1){				
				if(uF.parseToInt(getF_department())>-1){
					...
					/*if(uF.parseToInt(getF_level())>-1){
						viewPTaxReport();
						generatePTaxPdfReport();
					}else{
						viewPTaxReportByLevel(uF);
						generatePTaxPdfReportBy();
					}*/
...
//			System.out.println("pst==>"+pst);
	...
	private void viewPTaxReportByLevel(UtilityFunctions uF) {
...
//			System.out.println("pst==>"+pst);
	...
	private void generatePTaxPdfReportBy() {
		Database db=new Database();
		db.setRequest(request);
		Connection con=null;
		try {
		...
		String tbl = "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td align=\"center\"><font size=\"2\"><b>Professional Tax Register for the month of "+uF.getDateFormat(strMonth, "MM", "MMMM")+" "+uF.getDateFormat(strYear, "yyyy", "yyyy")+"</b></font></td></tr>" +
				"</table>";
		...
		String tbl1 = "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr>" +
				...
				"<td align=\"right\"><font size=\"1\"><b>&nbsp;PT Amount&nbsp;&nbsp;</b></font></td></tr>" +
		"</table>";
		...
		while(it.hasNext()){
			...
			"<td align=\"right\"><font size=\"1\">&nbsp;"+uF.showData((String)hmInner.get("PTAX_AMOUNT"), "0")+"&nbsp;&nbsp;</font></td></tr>" +
			"</table>";
...
//			System.out.println("pst==>"+pst);
	...
	public void generatePTaxPdfReport(){
