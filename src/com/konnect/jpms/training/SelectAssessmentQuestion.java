...
public class SelectAssessmentQuestion extends ActionSupport implements
...
//			System.out.println("Answer Type : "+ansType);
			...
			pst = con.prepareStatement("select * from assessment_question_bank where answer_type = ?"); // and question_type=? is_add=true and 
			pst.setInt(1, uF.parseToInt(ansType));
			rs = pst.executeQuery();
//			System.out.println("Answer Type pst ::::: "+pst);
			while (rs.next()) {
				sb.append("<option value=\"" + rs.getString("assessment_question_bank_id")
