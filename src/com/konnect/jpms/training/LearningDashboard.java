...
public class LearningDashboard implements ServletRequestAware, IStatements {
	...
	public String execute() {
		...
		request.setAttribute(PAGE, "/jsp/training/LearningDashboard.jsp");
		request.setAttribute(TITLE, "Learnings");
		...
		sbpageTitleNaviTrail.append("<li><i class=\"fa fa-graduation-cap\"></i><a href=\"Learnings.action\" style=\"color: #3c8dbc;\">Learnings</a></li>");
