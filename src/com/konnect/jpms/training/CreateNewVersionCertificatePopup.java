...
public class CreateNewVersionCertificatePopup extends ActionSupport implements ServletRequestAware, IStatements {
	...
	/*	request.setAttribute(PAGE, "/jsp/training/CreateNewVersionCertificatePopup.jsp");
		request.setAttribute(TITLE, "Create New Certificate");*/
