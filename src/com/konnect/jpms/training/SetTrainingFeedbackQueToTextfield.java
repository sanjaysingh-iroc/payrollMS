...
public class SetTrainingFeedbackQueToTextfield extends ActionSupport implements
...
//	List<FillOrientation> orientationList;
	...
	public String execute() throws Exception {
		...
		getTrainingFeedbackSelectedQuestion();
		setAllDetailsOfSelectedQue();
		return SUCCESS;

	}
	
	public void getTrainingFeedbackSelectedQuestion() {
		...
		try {
			...
			rs = pst.executeQuery();
			while (rs.next()) {
				queList.add(rs.getString("training_question_bank_id"));
				...
				quekey = rs.getString("training_question_bank_id");
