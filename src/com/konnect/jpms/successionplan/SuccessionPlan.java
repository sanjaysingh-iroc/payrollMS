...
public class SuccessionPlan implements ServletRequestAware, IStatements {
	...
	public String execute() {
		...
		if (CF == null) 
			return "login";
		request.setAttribute(PAGE, "/jsp/successionplan/SuccessionPlan.jsp");
		...
		/*if(strBaseUserType!=null && !strUserType.equalsIgnoreCase(ADMIN) && !strUserType.equalsIgnoreCase(HRMANAGER) && !strUserType.equalsIgnoreCase(RECRUITER)) { // && !strBaseUserType.equalsIgnoreCase(MANAGER) && !strBaseUserType.equalsIgnoreCase(HOD)
			request.setAttribute(PAGE, PAccessDenied);
			request.setAttribute(TITLE, TAccessDenied); 
			return ACCESS_DENIED;
		}*/
