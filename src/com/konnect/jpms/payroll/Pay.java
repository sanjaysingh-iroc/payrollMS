...
public class Pay extends ActionSupport implements ServletRequestAware, IStatements {
	...
	public String execute() throws Exception {
		...
		request.setAttribute(TITLE, "Pay");
		request.setAttribute(PAGE, "/jsp/payroll/Pay.jsp");
