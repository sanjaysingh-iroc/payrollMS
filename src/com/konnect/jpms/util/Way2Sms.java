...
//            System.exit(0);
    ...
    {  
        final String USERNAME="9371776597";//REQUIRED
        final String PASSWORD="123temple";//REQUIRED
        ...
        StringBuilder phoneNumber= new StringBuilder("9665875549");
        StringBuilder message=new StringBuilder("Testing");
    ...
    public void sendSMS(String strNumber, String strMessage)
    {  
        final String USERNAME="9371776597";//REQUIRED
        final String PASSWORD="123temple";//REQUIRED
        ...
        StringBuilder phoneNumber= new StringBuilder(strNumber);
        ...
        for(int i=0;i<arrPhoneNUmber.length;i++)
        {
         ...
         System.out.println("arrPhoneNUmber[i]=="+arrPhoneNUmber[i]);
