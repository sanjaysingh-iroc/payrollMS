...
public class GetProjectClientTask12 extends ActionSupport implements ServletRequestAware, IStatements{
	...
	public void getProjectList(){
		...
		try {
			...
			sb.append("<select name=\"strProject\" class=\"validateRequired\" onchange=\"getContent('myTask_"+count+"','GetProjectClientTask12.action?project_id='+this.value)\">");
