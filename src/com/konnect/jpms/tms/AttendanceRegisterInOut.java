...
public class AttendanceRegisterInOut  extends ActionSupport implements ServletRequestAware, IStatements {
...
//							}
							...
							//	System.out.println("hmEmpLeave.get(alDates.get(ii)------"+hmEmpLeave.get(alDates.get(ii)));
								if(hmHolidayDates.containsKey(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)) {
									alInner.add("<div style=\"width:100%;height:100%;background-color:"+hmHolidayDates.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)+";text-align:center\" class=\"blueColor\"> [H] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn:"/A")+"</div>");
									alInnerPrint.add(" [H] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn:"/A"));
									alInnerExport.add(new DataStyle(" [H] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn + strArrendanceInLoc:"/A"),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
									
									alInner.add("<div style=\"width:100%;height:100%;background-color:"+hmHolidayDates.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)+";text-align:center\" class=\"blueColor\"> [H] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut:"/A")+"</div>");
									alInnerPrint.add(" [H] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut:"/A"));
									alInnerExport.add(new DataStyle(" [H] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut+strArrendanceOutLoc:"/A"),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
									...
									if(!alLegends.contains("<div style=\"float:left;margin-right:5px;width:38px;height:100%;background-color:"+hmHolidayDates.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)+";text-align:center\" class=\"blueColor\"> H</div><div style=\"float:left;margin-right:5px;height:100%;text-align:center\"> "+uF.showData(hmHolidayName.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId), "")+"</div>")) {
									 ...
									 if(rosterWeeklyOffSet.contains(alDates.get(ii))) {
										...
										dblWOffCnt +=1;
										alInner.add("<div style=\"width:100%;height:100%;background-color:"+strColor+";text-align:center\" class=\"blueColor\"> [W/O] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn:"/A")+"</div>");
										alInnerPrint.add("[W/O] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn:"/A"));
										alInnerExport.add(new DataStyle("[W/O] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn+strArrendanceInLoc:"/A"),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
										
										alInner.add("<div style=\"width:100%;height:100%;background-color:"+strColor+";text-align:center\" class=\"blueColor\"> [W/O] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut:"/A")+"</div>");
										alInnerPrint.add("[W/O] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut:"/A"));
										alInnerExport.add(new DataStyle("[W/O] "+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut+strArrendanceOutLoc:"/A"),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
...
//									}
									...
									alInner.add("<div style=\"width:100%;height:100%;background-color:"+hmLeaveColor.get(hmEmpLeave.get(alDates.get(ii)))+";text-align:center\" class=\"greenColor\">"+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn:"/A")+"</div>");
									alInnerPrint.add(hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn:"/A"));
									alInnerExport.add(new DataStyle(hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn + strArrendanceInLoc:"/A"),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
									
									alInner.add("<div style=\"width:100%;height:100%;background-color:"+hmLeaveColor.get(hmEmpLeave.get(alDates.get(ii)))+";text-align:center\" class=\"greenColor\">"+hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut:"/A")+"</div>");
									alInnerPrint.add(hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut:"/A"));
									alInnerExport.add(new DataStyle(hmEmpLeave.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut+strArrendanceOutLoc:"/A"),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
							...
							//	System.out.println("hmEmpLeave.get(alDates.get(ii)------"+hmEmpLeave.get(alDates.get(ii)));
								...
								if(hmHolidayDates.containsKey(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)) {
									alInner.add("<div style=\"width:100%;height:100%;background-color:"+hmHolidayDates.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)+";text-align:center\" class=\"blueColor\"> [H] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn+")":"")+"</div>");
									alInnerPrint.add(" [H] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn+")":""));
									alInnerExport.add(new DataStyle(" [H] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn + strArrendanceInLoc+")":""),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
									
									alInner.add("<div style=\"width:100%;height:100%;background-color:"+hmHolidayDates.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)+";text-align:center\" class=\"blueColor\"> [H] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+")":"")+"</div>");
									alInnerPrint.add(" [H] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+")":""));
									alInnerExport.add(new DataStyle(" [H] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+strArrendanceOutLoc+")":""),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
									...
									if(!alLegends.contains("<div style=\"float:left;margin-right:5px;width:38px;height:100%;background-color:"+hmHolidayDates.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)+";text-align:center\" class=\"blueColor\"> H</div><div style=\"float:left;margin-right:5px;height:100%;text-align:center\"> "+uF.showData(hmHolidayName.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId), "")+"</div>")) {
									 ...
									 if(rosterWeeklyOffSet.contains(alDates.get(ii))) {
										String strColor=WEEKLYOFF_COLOR;
										dblWOffCnt +=1;
										alInner.add("<div style=\"width:100%;height:100%;background-color:"+strColor+";text-align:center\" class=\"blueColor\"> [W/O] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn+")":"")+"</div>");
										alInnerPrint.add("[W/O] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn+")":""));
										alInnerExport.add(new DataStyle("[W/O] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn+strArrendanceInLoc+")":""),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
										
										alInner.add("<div style=\"width:100%;height:100%;background-color:"+strColor+";text-align:center\" class=\"blueColor\"> [W/O] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+")":"")+"</div>");
										alInnerPrint.add("[W/O] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+")":""));
										alInnerExport.add(new DataStyle("[W/O] "+hmEmpLeave.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+strArrendanceOutLoc+")":""),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
...
//									}
									...
									alInner.add("<div style=\"width:100%;height:100%;background-color:"+hmLeaveColor.get(hmEmpLeave.get(alDates.get(ii)))+";text-align:center\" class=\"greenColor\">"+hmEmpLeave.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn+")":"")+"</div>");
									alInnerPrint.add(hmEmpLeave.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn+")":""));
									alInnerExport.add(new DataStyle(hmEmpLeave.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn + strArrendanceInLoc+")":""),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
									
									alInner.add("<div style=\"width:100%;height:100%;background-color:"+hmLeaveColor.get(hmEmpLeave.get(alDates.get(ii)))+";text-align:center\" class=\"greenColor\">"+hmEmpLeave.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+")":"")+"</div>");
									alInnerPrint.add(hmEmpLeave.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+")":""));
									alInnerExport.add(new DataStyle(hmEmpLeave.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+strArrendanceOutLoc+")":""),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
							...
							if("H".equals(hmEmpLeaveType.get(alDates.get(ii)))) {
								alInner.add("<div style=\"width:100%;height:100%;background-color:green;color:white;text-align:center\">"+hmEmpTravel.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn:"/A")+"</div>");
								alInnerPrint.add(hmEmpTravel.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn:"/A"));
								alInnerExport.add(new DataStyle(hmEmpTravel.get(alDates.get(ii))+" (HD) "+(strArrendanceIn!=null?"/"+strArrendanceIn + strArrendanceInLoc:"/A"),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
								
								alInner.add("<div style=\"width:100%;height:100%;background-color:green;color:white;text-align:center\">"+hmEmpTravel.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut:"/A")+"</div>");
								alInnerPrint.add(hmEmpTravel.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut:"/A"));
								alInnerExport.add(new DataStyle(hmEmpTravel.get(alDates.get(ii))+" (HD) "+(strArrendanceOut!=null?"/"+strArrendanceOut+strArrendanceOutLoc:"/A"),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
								...
								alInner.add("<div style=\"width:100%;height:100%;background-color:green;color:white;text-align:center\">"+hmEmpTravel.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn+")":"")+"</div>");
								alInnerPrint.add(hmEmpTravel.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn+")":""));
								alInnerExport.add(new DataStyle(hmEmpTravel.get(alDates.get(ii))+(strArrendanceIn!=null?" ("+strArrendanceIn + strArrendanceInLoc+")":""),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
								
								alInner.add("<div style=\"width:100%;height:100%;background-color:green;color:white;text-align:center\">"+hmEmpTravel.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+")":"")+"</div>");
								alInnerPrint.add(hmEmpTravel.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+")":""));
								alInnerExport.add(new DataStyle(hmEmpTravel.get(alDates.get(ii))+(strArrendanceOut!=null?" ("+strArrendanceOut+strArrendanceOutLoc+")":""),Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
...
//							}
							alInner.add("<div style=\"width:100%;height:100%;background-color:"+hmHolidayDates.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)+";text-align:center\" class=\"blueColor\"> H ("+(strArrendanceIn!=null?strArrendanceIn:"")+") </div>");
							alInnerPrint.add("H ("+(strArrendanceIn!=null?strArrendanceIn:"")+")");
							alInnerExport.add(new DataStyle("H ("+(strArrendanceIn!=null?strArrendanceIn+strArrendanceInLoc:"")+")",Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
							
							alInner.add("<div style=\"width:100%;height:100%;background-color:"+hmHolidayDates.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)+";text-align:center\" class=\"blueColor\"> H ("+(strArrendanceOut!=null?strArrendanceOut:"")+") </div>");
							alInnerPrint.add("H ("+(strArrendanceOut!=null?strArrendanceOut:"")+")");
							alInnerExport.add(new DataStyle("H ("+(strArrendanceOut!=null?strArrendanceOut+strArrendanceOutLoc:"")+")",Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
							if(strArrendanceOut==null || strArrendanceOut.equals("")) {
								absentCnt++;
							}
							if(!alLegends.contains("<div style=\"float:left;margin-right:5px;width:38px;height:100%;background-color:"+hmHolidayDates.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId)+";text-align:center\" class=\"blueColor\"> H</div><div style=\"float:left;margin-right:5px;height:100%;text-align:center\"> "+uF.showData(hmHolidayName.get(uF.getDateFormat(alDates.get(ii), DATE_FORMAT, CF.getStrReportDateFormat())+"_"+strWLocationId), "")+"</div>")) {
...
//								if(alEmployees.get(i).equals("12")) {
	...
	//							}
								String strColor=WEEKLYOFF_COLOR;
								dblWOffCnt +=1;
								alInner.add("<div style=\"width:100%;height:100%;background-color:"+strColor+";text-align:center\" class=\"blueColor\"> W/O"+(strArrendanceIn!=null?" ("+strArrendanceIn+")":"")+"</div>");
								alInnerPrint.add("W/O"+(strArrendanceIn!=null?" ("+strArrendanceIn+")":"")+"");
								alInnerExport.add(new DataStyle("W/O"+(strArrendanceIn!=null?" ("+strArrendanceIn+")":"")+"",Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
								
								alInner.add("<div style=\"width:100%;height:100%;background-color:"+strColor+";text-align:center\" class=\"blueColor\"> W/O"+(strArrendanceOut!=null?" ("+strArrendanceOut+")":"")+"</div>");
								alInnerPrint.add("W/O"+(strArrendanceOut!=null?" ("+strArrendanceOut+")":"")+"");
								alInnerExport.add(new DataStyle("W/O"+(strArrendanceOut!=null?" ("+strArrendanceOut+")":"")+"",Element.ALIGN_LEFT,"NEW_ROMAN",10,"0","0",BaseColor.WHITE));
