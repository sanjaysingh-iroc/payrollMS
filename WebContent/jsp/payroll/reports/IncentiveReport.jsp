...
function submitForm(type){
	document.frmIncentive.exportType.value='';
	...
	$.ajax({
		type : 'POST',
		url: 'IncentiveRegister.action?f_org='+org+paramValues,
...
function getSelectedValue(selectId) {
	...
	function generateIncentiveRegisterPdf() {
		/* var financialYear=document.frmIncentive.financialYear.value;
		var strMonth=document.frmIncentive.strMonth.value;
		var url='IncentiveRegisterPdfReport.action?financialYear='+financialYear;
		url+="&strMonth="+strMonth;
		window.location = url; */
		document.frmIncentive.exportType.value = 'pdf';
		document.frmIncentive.submit();
	}
...
<%-- <jsp:include page="../../common/SubHeader.jsp">
	<jsp:param value="Incentive Register" name="title"/>
</jsp:include> --%>
	...
	<div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
			<div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE;">
				...
				<div class="box-body" style="padding: 5px; overflow-y: auto; display: none;">
					<s:form name="frmIncentive" action="IncentiveRegister" theme="simple">
			...
			<!-- <div class="col-md-2" style="margin: 0px 0px 10px 0px; float: right;">
				<a onclick="generateIncentiveRegisterPdf();" href="javascript:void(0)" class="fa fa-file-pdf-o" >&nbsp;&nbsp;</a>
			</div>  -->
...
<a onclick="generateReportExcel();" href="javascript:void(0)" style="background-repeat: no-repeat;float: right;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
				...
				<%-- <div style="text-align:center;margin:10px" > <h2>Incentive Register for the month of <%=uF.getDateFormat(strMonth, "MM", "MMMM")%> <%=uF.getDateFormat(strYear, "yyyy", "yyyy")%> </h2></div> --%>

			<display:table name="reportList" class="table table-bordered" id="lt1">
				<%-- <display:setProperty name="export.excel.filename" value="IncentiveRegister.xls" />
				<display:setProperty name="export.xml.filename" value="IncentiveRegister.xml" />
				<display:setProperty name="export.csv.filename" value="IncentiveRegister.csv" /> --%>
				...
				<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Gross Salary"><%=((java.util.List) pageContext.getAttribute("lt1")).get(4)%></display:column>
				<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Incentive Amount"><%=((java.util.List) pageContext.getAttribute("lt1")).get(5)%></display:column>
			</display:table>
		</div>
		<!-- /.box-body -->
	</div>
