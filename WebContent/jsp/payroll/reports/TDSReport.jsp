...
function submitForm(type){
	document.frm_fromTDS.exportType.value='';
	...
	$.ajax({
		type : 'POST',
		url: 'TDSReport.action?f_org='+org+paramValues,
...
function generateTDSReport(){
	...
	window.location = url; */
	document.frm_fromTDS.exportType.value='pdf';
	document.frm_fromTDS.submit();
}
...
function generateReportExcel(){
	...
	url+="&f_service="+f_service+"&f_org="+f_org;
	window.location = url; */
	document.frm_fromTDS.exportType.value='excel';
	document.frm_fromTDS.submit();
}
...
<%-- <jsp:include page="../../common/SubHeader.jsp">
	<jsp:param value="TDS Register" name="title"/>
			...
			<div class="desgn" style="margin-bottom: 5px; background: #f5f5f5; color: #232323;">
				<div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE;">
					...
					<div class="box-body" style="padding: 5px; overflow-y: auto; display: none;">
						<s:form name="frm_fromTDS" action="TDSReport" theme="simple">
		...
		<!-- 	<div class="col-md-2" style="margin: 0px 0px 10px 0px; float: right;">
				<a onclick="generateTDSReport();" href="javascript:void(0)" class="fa fa-file-pdf-o"></a> 
		...
		<div class="col-md-2 pull-right">
			<a onclick="generateTDSReport();" href="javascript:void(0)" style="background-repeat: no-repeat;float: right;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
			<a onclick="generateReportExcel();" href="javascript:void(0)" style="background-repeat: no-repeat;float: right;"><i class="fa fa-file-excel-o" aria-hidden="true"></i></a>
				...
				<%-- <div style="text-align:center;margin:10px" > <h2>Tax Deducted at Source for the month of <%=uF.getDateFormat(strMonth, "MM", "MMMM")%> <%=uF.getDateFormat(strYear, "yyyy", "yyyy")%> </h2></div> --%>
				...
				<display:table name="reportList" cellspacing="1" class="table table-bordered" id="lt1">
					...
					<display:column style="text-align:right;" valign="top" title="TDS"><%=((java.util.List) pageContext.getAttribute("lt1")).get(4)%></display:column>
					<display:column style="text-align:right;" valign="top" title="Education Cess"><%=((java.util.List) pageContext.getAttribute("lt1")).get(5)%></display:column>
					<display:column style="text-align:right;" valign="top" title="Standard Cess"><%=((java.util.List) pageContext.getAttribute("lt1")).get(6)%></display:column>
					<display:column style="text-align:right;" valign="top" title="Total TDS"><%=((java.util.List) pageContext.getAttribute("lt1")).get(7)%></display:column>
				</display:table>
				<% } else {
						String title = "";
			...
			<display:table name="reportList" cellspacing="1" class="table table-bordered" id="lt1">
				...
				<display:column style="text-align:right;" valign="top" title="TDS"><%=((java.util.List) pageContext.getAttribute("lt1")).get(3)%></display:column>
				<display:column style="text-align:right;" valign="top" title="Education Cess"><%=((java.util.List) pageContext.getAttribute("lt1")).get(4)%></display:column>
				<display:column style="text-align:right;" valign="top" title="Standard Cess"><%=((java.util.List) pageContext.getAttribute("lt1")).get(5)%></display:column>
				<display:column style="text-align:right;" valign="top" title="Total TDS"><%=((java.util.List) pageContext.getAttribute("lt1")).get(6)%></display:column>
			</display:table>
			<% } %>
