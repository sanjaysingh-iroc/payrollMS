...
function submitForm(type){
	...
	$.ajax({
		type : 'POST',
		url: 'LeavePendingReport.action?f_org='+org+paramValues, 
	...
	<div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
		<div class="desgn" style="margin-bottom: 5px;color:#232323;">
            <div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE; margin-top: 10px;">
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                    <div class="content1">
                        <s:form name="frm" action="LeavePendingReport" theme="simple">
		...
		<div class="scroll">
			<display:table name="reportList" cellspacing="1" class="table table-bordered" id="lt">
				...
				<display:column style="align:left;" nowrap="nowrap" title="Approving Profile" sort="false">-</display:column><%-- <%=((java.util.List) pageContext.getAttribute("lt")).get(9)%> --%>	
			</display:table>
		</div>
	</div>
