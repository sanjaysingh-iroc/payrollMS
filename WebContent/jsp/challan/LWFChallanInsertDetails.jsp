...
$("#formLWFUpdateChallanData").submit(function(e){
	...
	<s:form id="formLWFUpdateChallanData" action="LWFUpdateChallanData" method="post" name="formLWFUpdateChallanData" theme="simple">
		...
		<div style="float: center" id="tblDiv">
			<table border="0" class="table table-bordered">
				<tr><td><strong>Print the challan</strong></td></tr>
			</table>
			<!-- 
			Amount Unpaid -->
			<table border="0" class="table table-bordered">
