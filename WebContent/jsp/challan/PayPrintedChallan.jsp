...
<script type="text/javascript">
	...
	//	System.out.println(" sbEmp in PayPrintedChallan.jsp==>"+sbEmp);
	
		
	%>

		<s:form name="formUpdateChallanData" id="formUpdateChallanData" action="UpdateChallanData" method="post" enctype="multipart/form-data" theme="simple">		
			...
			<div style="margin: 0px 0px 0px 210px">
				<table class="formcss">
					<tr>
						<td class="txtlabel alignLeft"><s:submit value="Submit" cssClass="btn btn-primary" name="strSubmit" id="strSubmit"></s:submit>
						</td>
						<td></td>
					</tr>
				</table>
