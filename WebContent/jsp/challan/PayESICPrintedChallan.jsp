...
System.out.println(" sbEmp in PayESICPrintedChallan.jsp==>"+sbEmp);
%>
	<s:form id="formESICUpdateChallanData" action="ESICUpdateChallanData" method="post" name="formESICUpdateChallanData" enctype="multipart/form-data" theme="simple">		
		...
		<s:hidden name="f_strWLocation"></s:hidden>
			...
			<table border="0" class="table table-bordered">
				...
				<tr>
					<td class="txtlabel alignLeft">Mode of Payment:</td>
					<td class="txtlabel alignLeft"><s:textfield id="paymentMode" name="paymentMode"></s:textfield> </td>
				</tr>
				<tr>
				...
				<tr>
					<td class="txtlabel alignLeft">Bank Name:</td>
					<td class="txtlabel alignLeft"><s:textfield id="bankName" name="bankName"></s:textfield> </td>
				</tr>
				<tr>
					<td class="txtlabel alignLeft">Bank Branch:</td>
					<td class="txtlabel alignLeft"><s:textfield id="bankBranch" name="bankBranch"></s:textfield> </td>
				</tr>
			</table>
		</div>		
		<div class="clr"></div>
		<div style="margin: 0px 0px 0px 210px">
			<table class="formcss">
				<tr>
					<td class="txtlabel alignLeft"><s:submit value="Submit" cssClass="btn btn-submit" name="strSubmit" id="strSubmit"></s:submit>
					</td>
					<td></td>
				</tr>
			</table>
