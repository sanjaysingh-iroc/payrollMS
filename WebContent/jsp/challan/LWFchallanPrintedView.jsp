...
%>
			...
			<table border="0" class="table table-bordered">
				<tr>
					<td><strong>Challan printed but not paid for <%=uF.showData(strCurrency,"")%> <%=uF.showData(totalunpaidamount, "0")%></strong></td>
				</tr>
			</table>
			<table border="0" class="table table-bordered">
				<tr>
				...
				<tr>
					...
					<td class="txtlabel alignRight"><b><%=uF.showData(totalunpaidamount, "0")%></b></td>
				</tr>
			</table>
