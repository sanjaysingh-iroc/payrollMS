...
//	System.out.println(" sbEmp in PayTDSPrintedChallan.jsp==>"+sbEmp);
%>

	<s:form id="formTDSUpdateChallanData" action="TDSUpdateChallanData" method="post" name="formTDSUpdateChallanData" enctype="multipart/form-data" theme="simple">		
		...
		<input type="hidden" name="sbEmp" value="<%=sbEmp%>"/>
			...
			<table border="0" class="table table-bordered">
				...
				<tr>
					<td class="txtlabel alignLeft">Mode of TDS Deposited:</td>
					<td class="txtlabel alignLeft"><s:textfield id="modeTDSDeposit" name="modeTDSDeposit"></s:textfield> </td>
				</tr>
				<tr>
