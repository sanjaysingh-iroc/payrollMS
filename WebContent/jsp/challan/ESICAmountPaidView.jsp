...
double totalPaidamount=uF.parseToDouble(totalEEunpaidamount)+uF.parseToDouble(totalERunpaidamount);
...
<div class="leftbox reportWidth" id="div_id_docs">
	...
	<s:form id="formID" action="UpdateChallanData" method="post" name="frm"
		...
		<div style="float: center" id="tblDiv">
			<table>
				...
				<tr>
					<td><strong>Rs.<%=uF.showData(uF.formatIntoComma(totalPaidamount)+"", "0")%>, challan amount paid.</strong></td>
				</tr>
			</table>
		</div>
		
			<table width="100%" class="tb_style" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="txtlabel alignRight"><b><%=uF.showData(uF.formatIntoComma(uF.parseToDouble(totalEEunpaidamount))+"", "0") %></b></td>
					<td class="txtlabel alignRight"><b><%=uF.showData(uF.formatIntoComma(uF.parseToDouble(totalERunpaidamount))+"", "0") %></b></td>
				</tr>
			</table>
		<%
