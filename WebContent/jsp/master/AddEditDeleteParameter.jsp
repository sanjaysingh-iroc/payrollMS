...
<script>
	...
	%>
		...
		<s:form theme="simple" action="AddEditDeleteParameter" method="POST" cssClass="formcss" id="formAddEditDeleteParameter" name="formAddEditDeleteParameter">
			<s:hidden name="parameterId" />
			...
			<table class="table table_no_border">
				...
				<tr>
					...
					<td><s:textfield name="parameterName" cssClass="validateRequired"/><span class="hint">Name of the parameter.<span class="hint-pointer">&nbsp;</span></span></td> 
				</tr>
				
				<tr>
					<th class="txtlabel alignRight" valign="top">Description:</th>
					<td><s:textarea name="parameterDescription" rows="3" cols="22"/><span class="hint">Description of the parameter.<span class="hint-pointer">&nbsp;</span></span></td> 
				</tr>
