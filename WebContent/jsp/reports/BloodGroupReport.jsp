...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function() {
    	...
    	$("#f_bloodGroup").multiselect().multiselectfilter();
    ...
    function submitForm(type) {
    	...
    	var strBloodGroup = getSelectedValue("f_bloodGroup");
    	
    	var paramValues = "";
    	if(type == '2') {
    		paramValues = '&strDepartment='+department+'&strDesignation='+designation+'&strBloodGroup='+strBloodGroup+'&strEmployeType='+strEmployeType;
    	}
    	//alert("service ===>> " + service); +'&startDate='+startDate
    	$("#divResult").html('<div id="the_div"><div id="ajaxLoadImage"></div></div>');
    	$.ajax({
    		type : 'POST',
    		url: 'BloodGroupReport.action?f_org='+org+paramValues, 
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
                        <div class="desgn" style="margin-bottom: 5px; color:#232323;">
                            <div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE;">
                                ...
                                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                                    <div class="content1">
                                        <s:form name="frmBloodGroupReport" action="BloodGroupReport" theme="simple">
                                            ...
                                            <div class="row row_without_margin">
												...
												<div class="col-lg-11 col-md-11 col-sm-12 paddingleft0 paddingright0">
													...
													<div class="col-lg-2 col-md-6 col-sm-12 autoWidth paddingleftright5">
														<p style="padding-left: 5px;">Blood Group</p>
														<s:select theme="simple" name="f_bloodGroup" id="f_bloodGroup" listKey="bloodGroupId" listValue="bloodGroupName" list="bloodGroupList" key=""  multiple="true"  />
													</div>
													<div class="col-lg-2 col-md-6 col-sm-12 autoWidth paddingleftright5">
                        ...
                        <div class="scroll" style="width:100%">
                            <display:table name="reportList" cellspacing="1" class="table table-bordered" id="lt1">
					     		<display:setProperty name="export.excel.filename" value="BloodGroupReport.xls" />
								<display:setProperty name="export.xml.filename" value="BloodGroupReport.xml" />
								<display:setProperty name="export.csv.filename" value="BloodGroupReport.csv" />
								...
								<display:column style="text-align:left;" valign="top" title="Blood Group"><%=((Map) pageContext.getAttribute("lt1")).get("empBloodGroup")%></display:column>
                            </display:table>
                        </div>
                </div>
                <!-- /.box-body -->
