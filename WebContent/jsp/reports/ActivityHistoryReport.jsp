...
function submitForm(type) {
	document.frm_ActivityHistoryReport.exportType.value='';
	...
	if(type == '2') {
		...
		+'&strEmpId='+strEmpId+'&calendarYear='+calendarYear+'&strMonth='+strMonth;
	}
	//alert("service ===>> " + service);
	$("#divResult").html('<div id="the_div"><div id="ajaxLoadImage"></div></div>');
	$.ajax({
		type : 'POST',
		url: 'ActivityHistoryReport.action?f_org='+org+'&strActivity='+strActivity+paramValues,
 		...
 		<div class="desgn" style="margin-bottom: 5px; color:#232323;">
			<div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE; margin-top: 10px;">
				...
				<div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
					<s:form name="frm_ActivityHistoryReport" id="frm_ActivityHistoryReport" action="ActivityHistoryReport" theme="simple">
						...
						<div class="row row_without_margin">
							...
							<div class="col-lg-11 col-md-11 col-sm-12 paddingleft0 paddingright0">
								<div class="col-lg-2 col-md-6 col-sm-12 autoWidth paddingleftright5">
									...
									<s:select theme="simple" name="strActivity" id="strActivity" listKey="activityId" listValue="activityName" headerKey="" headerValue="Select Activity" list="activityList" key="" onchange="submitForm('1');"/>
								</div>
								<div class="col-lg-2 col-md-6 col-sm-12 autoWidth paddingleftright5">
	      ...
	      <div style="width:100%; overflow: auto;">
			...
			<display:table name="reportList" cellspacing="1" class="table table-bordered" id="lt">
				...
				<%if(uF.parseToInt(strActivity) == uF.parseToInt(IConstants.ACTIVITY_EXTEND_PROBATION_ID) || uF.parseToInt(strActivity) == uF.parseToInt(IConstants.ACTIVITY_NOTICE_PERIOD_ID) || uF.parseToInt(strActivity) == uF.parseToInt(IConstants.ACTIVITY_PROBATION_ID)) { %>
				...
				<% } %>
				<%if(uF.parseToInt(strActivity) == uF.parseToInt(IConstants.ACTIVITY_CONFIRMATION_ID)) { %>
				...
				<% } %>
				<%if(uF.parseToInt(strActivity) == uF.parseToInt(IConstants.ACTIVITY_GRADE_CHANGE_ID)) { %>
				...
				<% } %>
				<%if(uF.parseToInt(strActivity) == uF.parseToInt(IConstants.ACTIVITY_INCREMENT_ID)) { %>
				...
				<display:column style="text-align:right;" nowrap="nowrap" title="Increment Percentage" sort="false"><%=((java.util.List) pageContext.getAttribute("lt")).get(6)%></display:column>
				<% } %>
				<%if(uF.parseToInt(strActivity) == uF.parseToInt(IConstants.ACTIVITY_PROMOTION_ID)) { %>
				...
				<% } %>
				<%if(uF.parseToInt(strActivity) == uF.parseToInt(IConstants.ACTIVITY_TRANSFER_ID)) { %>
				...
				<%if(uF.parseToBoolean(isDocActivity)) { %>
