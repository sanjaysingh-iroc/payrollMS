...
function submitForm(type) {
	var strOrg = document.getElementById("strOrg").value;
	var financialYear = document.getElementById("financialYear").value;
	var action = 'ContributionAmountAssignPolicy.action?strOrg='+strOrg+'&financialYear='+financialYear;
	if(type == '2'){
		var strLevel = document.getElementById("strLevel").value;
...
function importContribution(){
	//financialYear strOrg strLevel strSalaryHeadId 
	 ...
	 $("#modalInfo").show();
	 $(".modal-title").html('Import Contribution');
	 $.ajax({
			url : "ImportAnnualVariable.action?callFrom=ICONTRI&financialYear="+financialYear+"&strOrg="+strOrg+"&strLevel="+strLevel+"&strSalaryHeadId="+strSalaryHeadId,
			cache : false,
		...
		<div class="box-body" style="min-height: 600px;">
			<div class="box box-default collapsed-box">
				...
				<div class="box-body" style="padding: 5px; overflow-y: auto;">
					<s:form name="frm" action="ContributionAmountAssignPolicy" theme="simple">
						...
						<div style="float: left; width: 99%; margin-left: 10px;">
							...
							<div style="float: left; width: 98%;">
								...
								<div style="float: left; margin-left: 10px;">
									<p style="padding-left: 5px;">Contribution Head</p>
			...
			<div style="text-align: right;">
				<a href="javascript:void(0)" onclick="importContribution();">Import Contribution</a>
			</div>
			<%
				}
			%>
			<div class="col-md-12">
				<ul class="level_list">
					...
					<%
						if (uF.parseToInt(strSalaryHeadId) == 0) {
					%>
						<li><div class="msg nodata"><span>Please choose contribution head.</span></div></li>
					<%
						} else if (alEmp.size() == 0) {
					%>
						<li><div class="msg nodata"><span>Please assign contribution head to employee.</span></div></li>
					<%
						}
					%>
