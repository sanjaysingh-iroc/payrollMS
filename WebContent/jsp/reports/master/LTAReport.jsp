									...
									aButtons: [
										"csv", "xls", {
											...
											//sPdfMessage: "Your custom message would go here."
			                           			...
			                           			sAddURL: "AddLTA.action?operation=A",
												sDeleteURL: "AddLTA.action?operation=D",
												"aoColumns": [
		                    									{
		                    										cssclass:"required",
		                    										indicator: 'Saving...',
		                                                         	...
		                                                         	submit:'Save',
	                                                         		sUpdateURL: "AddLTA.action?operation=U"
		                    									},
		                    									{
		                    										cssclass:"required",
		                    										indicator: 'Saving...',
...
<jsp:include page="../../master/AddLTA.jsp" flush="true" />  
<%} %>

<jsp:include page="../../common/SubHeader.jsp">
	<jsp:param value="LTA /LTC List" name="title"/> 
</jsp:include>
...
<table class="display" id="lt">
	<thead>
		<tr>
			...
			<th style="text-align: left;">LTA From</th>
			<th style="text-align: left;">LTA To</th>
			<th style="text-align: left;">LTA Limit</th>
		</tr>
	</thead>
	<tbody>
