					 				...
					 				aButtons: [
										"csv", "xls", {
											...
											//sPdfMessage: "Your custom message would go here."
			                           			...
			                           			sAddURL: "AddWlocationType.action?operation=A",
												sDeleteURL: "AddWlocationType.action?operation=D",
												"aoColumns": [
		                    									{
		                    										cssclass:"required",
		                    										indicator: 'Saving...',
		                                                         	...
		                                                         	submit:'Save',
	                                                         		sUpdateURL: "AddWlocationType.action?operation=U"
		                    									},
		                    									{
		                    										indicator: 'Saving...',
		                                                         	tooltip: 'Click to edit ',		                                                         	
												...
												oAddNewRowFormOptions: { 	
	                                                    title: 'Add a new Work Location Type',
														show: "blind", 
														width: '700px',
														modal: true,
														hide: "explode"
...
<jsp:include page="../../master/AddWlocationType.jsp" flush="true" />  
<%} %>
 

<jsp:include page="../../common/SubHeader.jsp">
	<jsp:param value="Work LocationType List" name="title"/>
</jsp:include>
...
<table class="display" id="lt">
	<thead>
		<tr>
			<th style="text-align: left;">Work Location Type Code</th>
			<th style="text-align: left;">Work Location Type Name</th>
			<th style="text-align: left;">Work Location Type Description</th>
		</tr>
	</thead>
	<tbody>
