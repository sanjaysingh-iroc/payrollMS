									...
									aButtons: [
										"csv", "xls", {
											...
											//sPdfMessage: "Your custom message would go here."
			                           			...
			                           			sAddURL: "AddExemption.action?operation=A",
												sDeleteURL: "AddExemption.action?operation=D",
												"aoColumns": [
		                    									{
		                    										cssclass:"required",
		                    										indicator: 'Saving...',
		                                                         	...
		                                                         	submit:'Save',
	                                                         		sUpdateURL: "AddExemption.action?operation=U"
		                    									},
		                    									{
		                    										cssclass:"required",
		                    										indicator: 'Saving...',
												...
												oAddNewRowFormOptions: { 	
	                                                    title: 'Add a new exemption slab',
														show: "blind", 
														width: '700px',
														modal: true,
														hide: "explode"
...
<jsp:include page="../common/SubHeader.jsp">
	<jsp:param value="Exemption List" name="title"/>
</jsp:include> 
...
<table class="display" id="lt">
	<thead>
		<tr>
			...
			<th style="text-align: left;">Exemption From</th> 
			<th style="text-align: left;">Exemption To</th>
