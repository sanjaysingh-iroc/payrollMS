...
<%
   	...
   	List<List<String>> alLanguages = (List) request.getAttribute("alLanguages");
   	List<List<String>> alEducation = (List) request.getAttribute("alEducation");
   	List<List<String>> alFamilyMembers = (List) request.getAttribute("alFamilyMembers");
   	List<List<String>> alPrevEmployment = (List) request.getAttribute("alPrevEmployment");
   	Map<String, String> hmEmpPrevEarnDeduct = (Map<String, String>)request.getAttribute("hmEmpPrevEarnDeduct");
   	
   	List<List<String>> alActivityDetails = (List) request.getAttribute("alActivityDetails");
...
<div id="printDiv" class="leftbox reportWidth" style="font-size: 12px;">
 ...
 <div class="leftholder" style="width:40%;border:solid 0px #ccc" >
    ...
    <div class="trow" style="background:#fff; margin:0px; width:92%; min-height: 190px;">
               ...
               <div style="float:left; padding:5px; width:90px;">
                       <div style="height:82px; width:84px; float:left; margin:2px 10px 0px 0px">
                                <img height="100" width="100" class="lazy img-circle" id="profilecontainerimg" style="border:1px solid #CCCCCC;" src="userImages/avatar_photo.png" data-original="<%=docRetriveLocation + hmEmpProfile.get("IMAGE")%>" />
                      </div>
		...
		<div class="trow">
			<div class="fieldset">
	            ...
	            %>
                 ...
                 <div style="float:left; width:104%; margin-left: -4px; margin-top :10px; margin-bottom: 10px;">		
                 	...
                 	<table cellspacing="1" cellpadding="2" class="tb_style" style="float: left;">
						...
						<tr>
							<td nowrap="nowrap" class="alignRight">Salary Head</td>
						...
						%>
								<tr>
									<td nowrap="nowrap" class="alignRight"><%=uF.showData(innerList.get(0), "-")%></td>
                    ...
                    <div style="float:left; border:solid 0px #ccc; width:93%; margin:0px 0px 0px 10px"> 
             			...
             			<div class="lholder">
	                              ...
	                              <div class="lblock">
	                                     ...
	                                     <div style="float:right">
											...
											<% } %>
	                                         ...
	                                         <p class="act_title" style="background:<%=(nDoc == 0) ? "" : "orange"%>"><strong><%=innerList.get(5)%> <%=(nDoc == 0) ? "" : "<a href=\"DownloadDocument.action?doc_id=" + nDoc
								+ "\"><i class=\"fa fa-file-pdf-o\" aria-hidden=\"true\" style=\"margin-left:5px;height:16px;float:right;\"  ></i></a>"%></strong></p>
	             		 ...
	             		 <div class="rholder">
								...
								+ "\"><i class=\"fa fa-file-pdf-o\" aria-hidden=\"true\" style=\"margin-left:5px;height:16px;float:right;\"  ></i></a>"%></strong></p>
				                                     <p><%=innerList.get(5)%> on <%=innerList.get(7)%>
			                                     	 <%=((innerList.get(6))).length() != 0 ? "for " + innerList.get(6) : ""%>
					                                </p> 
		                                  		</div> 
		                                </div>  
		                                <div class="clr"></div>
