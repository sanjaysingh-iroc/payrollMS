...
<script type="text/javascript" charset="utf-8">
    ...
    function submitForm(type) {
    	...
    	$.ajax({
    		type : 'POST',
    		url: 'Retirementreport.action?f_org='+org+paramValues, 
	...
	<div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
		<div class="desgn" style="margin-bottom: 5px; color:#232323;">
			<div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE;">
				...
				<div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
					<div class="content1">
						<s:form name="frmRetirementreport" action="Retirementreport" theme="simple">
		...
		<div class="scroll" style="width:100%">
			<display:table name="reportList" cellspacing="1" class="table table-bordered" id="lt1" style="overflow-x: auto;">
				<display:setProperty name="export.excel.filename" value="Retirementreport.xls" />
				<display:setProperty name="export.xml.filename" value="Retirementreport.xml" />
				<display:setProperty name="export.csv.filename" value="Retirementreport.csv" />
			...
			<display:column style="text-align:left;" valign="top" title="Date of Birth"><%=((Map) pageContext.getAttribute("lt1")).get("empdob")%></display:column>
			</display:table>
        </div>
	</div>
	<!-- /.box-body -->
