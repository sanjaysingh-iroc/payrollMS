...
<div id="divResult">
	...
	<script type="text/javascript" charset="utf-8">
		...
		function submitForm(type){
	    	document.frmEmpWorkForce.exportType.value='';
	    	...
	    	$.ajax({
	    		type : 'POST',
	    		url: 'EmployeeWorkForceReport.action?f_org='+org+paramValues, 
	...
	<div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
		<div class="desgn" style="margin-bottom: 5px; color:#232323;">
			<div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE;">
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                	<div class="content1">
                		<s:form name="frmEmpWorkForce" action="EmployeeWorkForceReport" theme="simple">
		...
		<div class="scroll" style="width:100%">
			<display:table name="reportList" cellspacing="1" class="table table-bordered overflowtable" id="lt1">
            	<display:setProperty name="export.excel.filename" value="EmployeeWorkForceReport.xls" />
				<display:setProperty name="export.xml.filename" value="EmployeeWorkForceReport.xml" />
				<display:setProperty name="export.csv.filename" value="EmployeeWorkForceReport.csv" />
                ...
                <display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Projects"><%=((java.util.List) pageContext.getAttribute("lt1")).get(33)%></display:column>
