...
<script type="text/javascript" charset="utf-8">
		...
		/* $('#lt1').DataTable({
		 ...
		 $('#lt1').DataTable( {
		        ...
		        buttons: [
		            ...
		            {
		                extend: 'csv',
		                title: 'Actual Confirmation Report'
		            },
		            {
		                extend: 'excel',
		                title: 'Actual Confirmation Report'
    ...
    function submitForm(type) {
    	...
    	$.ajax({
    		type : 'POST',
    		url: 'ActualConfirmationReport.action?f_org='+org+paramValues, 
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
                        <div class="desgn" style="margin-bottom: 5px; color:#232323;">
                            <div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE;">
                                ...
                                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                                    <div class="content1">
                                        <s:form name="frmActualConfirmationReport" action="ActualConfirmationReport" theme="simple">
                        ...
                        <div class="scroll" style="width:100%">
                            <display:table name="reportList" cellspacing="1" class="table table-bordered overflowtable" id="lt1">
					     		<display:setProperty name="export.excel.filename" value="ActualConfirmationReport.xls" />
								<display:setProperty name="export.xml.filename" value="ActualConfirmationReport.xml" />
								<display:setProperty name="export.csv.filename" value="ActualConfirmationReport.csv" />
								...
								<display:column style="text-align:left;" valign="top" title="Actual Confirmation Date"><%=((Map) pageContext.getAttribute("lt1")).get("actual_confirmation_date")%></display:column>
                            </display:table>
                        </div>
                </div>
                <!-- /.box-body -->
