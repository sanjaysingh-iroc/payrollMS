...
<s:form name="frmWorkForce" action="WorkForceJoin" theme="simple">
...
<div class="filter_div">
    ...
    <s:select theme="simple" name="f_level" listKey="levelId" headerValue="All Levels"  cssStyle="float:left;margin-right: 10px;"
     ...
     <s:submit value="Submit" cssClass="input_button" cssStyle="margin:0px"></s:submit>
...
<display:table name="alReport" cellspacing="1" class="itis" export="true" 
	pagesize="50" id="lt1" requestURI="WorkForceJoin.action" width="100%">
