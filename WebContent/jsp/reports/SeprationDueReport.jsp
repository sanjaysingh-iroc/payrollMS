...
<script type="text/javascript" charset="utf-8">
    ...
    function submitForm(type) {
    	...
    	$.ajax({
    		type : 'POST',
    		url: 'SeprationDueReport.action?f_org='+org+paramValues, 
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
                        <div class="desgn" style="margin-bottom: 5px; color:#232323;">
                            <div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE;">
                                ...
                                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                                    <div class="content1">
                                        <s:form name="frmSeprationDueReport" action="SeprationDueReport" theme="simple">
                        ...
                        <div class="scroll" style="width:100%">
                            <display:table name="reportList" cellspacing="1" class="table table-bordered overflowtable" id="lt1">
					     		<display:setProperty name="export.excel.filename" value="SeprationDueReport.xls" />
								<display:setProperty name="export.xml.filename" value="SeprationDueReport.xml" />
								<display:setProperty name="export.csv.filename" value="SeprationDueReport.csv" />
								...
								<display:column style="text-align:left;" valign="top" title="Designation"><%=((Map) pageContext.getAttribute("lt1")).get("empdesignation_name")%></display:column>
								<display:column style="text-align:left;" valign="top" title="Joining Date"><%=((Map) pageContext.getAttribute("lt1")).get("empjoining_date")%></display:column>
								<display:column style="text-align:left;" valign="top" title="Sepration Date"><%=((Map) pageContext.getAttribute("lt1")).get("empseparation_date")%></display:column>
                            </display:table>
                        </div>
                </div>
                <!-- /.box-body -->
