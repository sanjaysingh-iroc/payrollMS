...
<% 	
	...
	List wLocation = (List) request.getAttribute("wLocation");
...
<%if(session.getAttribute(IConstants.USERID)!=null){ %>
      <span><%=(request.getParameter("operation")!=null)?"Edit":"Add" %> Trainer Detail</span>
<%}else{ %>
...
<%
if (request.getAttribute("operation") == null || ((String) request.getAttribute("operation")).equalsIgnoreCase("")) {
	%>
...
<%
		} else if (request.getAttribute("operation") != null && ((String) request.getAttribute("operation")).equalsIgnoreCase("U")) {
	%>
	...
	<div class="steps">
		...
		<s:if test="step==1">
			<span class="current"> Personal Information :</span>
		  	<span class="next"><a
				href="AddTrainer.action?operation=U&step=1&empId=<%=request.getAttribute("empId")%>"
				style="color: #5A87B4; font-weight: normal; font-size: 11px;">Background Information :</a></span>
		  	<span class="next"><a
				href="AddTrainer.action?operation=U&step=2&empId=<%=request.getAttribute("empId")%>"
				style="color: #5A87B4; font-weight: normal; font-size: 11px;"> Previous Employment :</a></span>
		   	<span class="next"><a
				href="AddTrainer.action?operation=U&step=3&empId=<%=request.getAttribute("empId")%>"
				style="color: #5A87B4; font-weight: normal; font-size: 11px;"> References :</a></span>
		   	<span class="next"><a
				href="AddTrainer.action?operation=U&step=4&empId=<%=request.getAttribute("empId")%>"
				style="color: #5A87B4; font-weight: normal; font-size: 11px;"> Medical Information :</a></span>
		   	<span class="next"><a
				href="AddTrainer.action?operation=U&step=5&empId=<%=request.getAttribute("empId")%>"
				style="color: #5A87B4; font-weight: normal; font-size: 11px;"> Documentation :</a></span>			
		</s:if>
		<s:if test="step==2">
			<span class="prev"><a
				href="AddTrainer.action?operation=U&step=0&empId=<%=request.getAttribute("empId")%>"
...
<div class="panes">
	<s:if test="step==1 || mode=='report'">
		...
		<s:form theme="simple" action="AddTrainer" name="frmPersonalInfo" id="frmPersonalInfo" method="POST" cssClass="formcss" enctype="multipart/form-data">
			
			<div style="float: left;" >
			<table border="0" class="formcss">
			
			<tr><td><s:hidden name="empId" /></td></tr>
			<tr><td><s:hidden name="step" />
            ...
            Step 1 : </span> Enter Trainer Personal Information</td></tr>
			...
			<%if(session.getAttribute("isApproved")==null) {%>
				<s:textfield name="empFname" cssClass="validateRequired text-input" required="true"/>
			<%}else{%>
				<s:textfield name="empFname" required="true" disabled="true"/>
				<s:hidden name="empFname" />
			<%}%>
			
			<span class="hint">Trainer's first name.<span class="hint-pointer">&nbsp;</span></span></td></tr>
			...
			<td>
				...
				<s:textfield name="empLname" cssClass="validateRequired text-input" required="true"/>
			
			
			<span class="hint">Trainer's last name.<span class="hint-pointer">&nbsp;</span></span></td></tr>
			...
			<tr><td class="txtlabel alignRight">Address1<sup>*</sup>:</td><td><s:textfield name="empAddress1" cssClass="validateRequired text-input" required="true"/><span class="hint">Trainer current address.<span class="hint-pointer">&nbsp;</span></span></td></tr>
			<tr><td class="txtlabel alignRight">Address2:</td><td><s:textfield name="empAddress2" /><span class="hint">Trainer current address. (optional)<span class="hint-pointer">&nbsp;</span></span></td></tr>
			<tr><td colspan=2><s:fielderror ><s:param>city</s:param></s:fielderror></td></tr>
			<tr><td class="txtlabel alignRight">Suburb<sup>*</sup>:</td><td><s:textfield name="city" cssClass="validateRequired text-input" required="true"/><span class="hint">Add suburb.<span class="hint-pointer">&nbsp;</span></span></td></tr>
			...
			<tr><td class="txtlabel alignRight">Select State<sup>*</sup>:</td><td><s:select theme="simple" title="state" cssClass="validateRequired"
	...
	<!-- ===start parvez date: 30-07-2022=== -->		
			<%-- <tr><td class="txtlabel alignRight">Postcode:</td><td><s:textfield name="empPincode" label="Trainer Pincode" /><span class="hint">Trainer's residential pincode/zipcode.<span class="hint-pointer">&nbsp;</span></span></td></tr> --%>
			<tr><td class="txtlabel alignRight">Pincode:</td><td><s:textfield name="empPincode" label="Trainer Pincode" /><span class="hint">Trainer's residential pincode/zipcode.<span class="hint-pointer">&nbsp;</span></span></td></tr>
	<!-- ===end parvez date: 30-07-2022=== -->
			...
			<tr><td class="txtlabel alignRight">Address1<sup>*</sup>:</td><td><s:textfield name="empAddress1Tmp" cssClass="validateRequired text-input" required="true"/><span class="hint">Trainer current address.<span class="hint-pointer">&nbsp;</span></span></td></tr>
			<tr><td class="txtlabel alignRight">Address2:</td><td><s:textfield name="empAddress2Tmp" /><span class="hint">Trainer current address. (optional)<span class="hint-pointer">&nbsp;</span></span></td></tr>
			<tr><td class="txtlabel alignRight">Suburb<sup>*</sup>:</td><td><s:textfield name="cityTmp" cssClass="validateRequired text-input" required="true"/><span class="hint">Add suburb.<span class="hint-pointer">&nbsp;</span></span></td></tr>
	...
	<!-- ===start parvez date: 30-07-2022=== -->		
			<%-- <tr><td class="txtlabel alignRight">Postcode:</td><td><s:textfield name="empPincodeTmp" label="Trainer Pincode" /><span class="hint">Trainer's residential pincode/zipcode.<span class="hint-pointer">&nbsp;</span></span></td></tr> --%>
			<tr><td class="txtlabel alignRight">Pincode:</td><td><s:textfield name="empPincodeTmp" label="Trainer Pincode" /><span class="hint">Trainer's residential pincode/zipcode.<span class="hint-pointer">&nbsp;</span></span></td></tr>
	<!-- ===end parvez date: 30-07-2022=== -->
			...
			<tr><td class="txtlabel alignRight">Trainer Work Location<sup>*</sup>:</td><td>	<s:select theme="simple" name="strwLocation" listKey="wLocationId"
				...
				list="wLocationList" key="0" cssClass="validateRequired text-input"/></td></tr>

			<tr><td class="txtlabel alignRight">Landline Number<sup>*</sup>:</td><td><s:textfield name="empContactno" cssClass="validateRequired text-input" /><span class="hint">Trainer's contact no. (optional but recommended)<span class="hint-pointer">&nbsp;</span></span></td></tr>
			<tr><td class="txtlabel alignRight">Mobile Number<sup>*</sup>:</td><td><s:textfield name="empMobileNo" cssClass="validateRequired text-input" /><span class="hint">Trainer's Mobile No<span class="hint-pointer">&nbsp;</span></span></td></tr>
		<%-- 	
			...
			<tr><td class="txtlabel alignRight">PAN<sup>*</sup>:</td><td><s:textfield name="empPanNo" cssClass="validateRequired text-input" /><span class="hint">Trainer's PAN (optional but recommended)<span class="hint-pointer">&nbsp;</span></span></td></tr>
			<tr><td class="txtlabel alignRight">Provident Fund No :</td><td><s:textfield name="empPFNo" /><span class="hint">Trainer's Provident Number (optional but recommended)<span class="hint-pointer">&nbsp;</span></span></td></tr>
			<tr><td class="txtlabel alignRight">GPF Acc No :</td><td><s:textfield name="empGPFNo" /><span class="hint">Trainer's GPF Number <span class="hint-pointer">&nbsp;</span></span></td></tr>
		 --%>	
			...
			<s:textfield name="empDateOfBirth" id="empDateOfBirth" cssClass="validateRequired text-input" required="true"></s:textfield>
			<span class="hint">Trainer's Date Of Birth.<span class="hint-pointer">&nbsp;</span></span></td></tr>
			...
			<span class="hint">Trainer's Date Of Marriage.<span class="hint-pointer">&nbsp;</span></span></td></tr>
			...
			<div style="float:left; padding:10px; margin: 80px 100px; padding: 10px 30px;" >
				<table>
				<tr><td><strong>Update Trainer image</strong></td></tr>
			...
			<div style="float:right;">
				...
				<s:if test="operation==null">
					...
					<tr><td colspan="2" align="center">
						<s:submit cssClass="input_button" cssStyle="width:200px; float:right;" value="Submit & Proceed" align="center" name="stepSubmit"/>
					</td></tr>
				...
				<s:else>
					...
					<tr><td colspan="2" align="center">
						<s:hidden name="mode" />
						<s:submit cssClass="input_button" value="Update Trainer" align="center" name="stepSubmit"/>
					</td></tr>
	...
	<s:hidden name="operation"></s:hidden>
		...
		<table border="0" class="formcss">
			...
			<tr><td class="tdLabelheadingBg alignCenter" colspan="2"><span style="color:#68AC3B; font-size:18px">Step 5 : </span>Enter Trainer References 1:</td></tr>
		...
		<table border="0" class="formcss">
			...
			<tr><td class="tdLabelheadingBg alignCenter" colspan="2">Enter Trainer References 2:</td></tr>
...
<div>
    ...
    <div><span style="color:#68AC3B; font-size:18px">Step 2 : </span><span class="tdLabelheadingBg">Enter Trainers background information</span> </div>
    
	<div  id="div_skills">
    
        <h3 style="padding:0px;margin:5px 0px 10px 0px">Enter Trainer skills and their values</h3>
	...
	<div id="div_education">
       ...
       <h3 style="padding:0px;margin:5px 0px 10px 0px">Enter Trainer educational details</h3>
	...
	<h3 style="padding:0px;margin:5px 0px 10px 0px">Enter Trainer languages</h3>
	...
	<h3 style="padding:0px;margin:5px 0px 10px 0px">Enter Trainer hobbies</h3>
...
<tr><td class="tdLabelheadingBg alignCenter" colspan="2"><span style="color:#68AC3B; font-size:18px">Step 3 : </span>Enter Trainers Previous Employment </td></tr>
	</table>			
...
<s:form theme="simple" action="AddTrainer" id="frmMedicalInfo" method="POST" cssClass="formcss" enctype="multipart/form-data">
	...
	<s:hidden name="operation"></s:hidden>
	<table border="0" class="formcss">
	    <tr><td  class="tdLabelheadingBg alignCenter" colspan="2"><span style="color:#68AC3B; font-size:18px">Step 5 : </span>Medical Information :-</td></tr>
	</table>
	    
	<table border="0" class="formcss">
	
		<tr><td class="tdLabelheadingBg alignCenter" colspan="2">Enter Trainer's Medical Information </td></tr>
		<tr>
			<td>
	            <table>
...
<form action="AddTrainer.action" id="frmDocumentation" method="POST" class="formcss" enctype="multipart/form-data">
<div style="height: auto; width:100%; float: left; border: solid 0px black; overflow: auto;" id="div_id_docs">
	<s:hidden name="empId" />
	<s:hidden name="step" />
	<s:hidden name="operation"></s:hidden>
		<table border="0" class="formcss">
	    <tr><td  class="tdLabelheadingBg alignCenter" colspan="2"><span style="color:#68AC3B; font-size:18px">Step 6 : </span>Attach Documents :-</td></tr>
	    </table>
				...
				%>
				 ...
				 <div id="row_document">
                    <table>
				 		...
				 		<td class="txtlabel alignRight"><input type="text" style="width: 180px;" class="validateRequired" name="idDocName" ></input></td>
						<td class="txtlabel alignRight"><input type="file" name="idDoc"/></td>
                    </table>
				</div>
				...
				<div id="row_document">
                    <table>
				 		...
				 		<td class="txtlabel alignRight"><input type="text" class="validateRequired" style="width: 180px;" name="idDocName" ></input></td>
						<td class="txtlabel alignRight"><input type="file" name="idDoc"/></td>
                    </table>
				</div>
