...
<div class="leftbox reportWidth">
	...
	<div id="queAsnDiv" style="width: 100%;">
		...
		<div>
			<s:form action="AddTrainingFeedback" id="frmAddTrainingFeedback" method="POST" theme="simple">
							...
							<ul style="margin: 10px 10px 10px 30px">
								<li>
									...
									<div>
										...
										<textarea rows="5" cols="50" name="<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" style="width:100%" readonly="readonly"><%=innerMp.get("REMARK") != null ? innerMp.get("REMARK") : ""%></textarea>
									</div> 
 ...
 %>
									<div>
										a) <input type="checkbox" value="a" <%if (innerMp.get("ANSWER") != null && innerMp.get("ANSWER").contains("a")) {%>
											checked <%}%> name="correct<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" readonly="readonly"/><%=innerlist.get(4)%><br />
										...
										c) <input type="checkbox" value="c" <%if (innerMp.get("ANSWER") != null && innerMp.get("ANSWER").contains("c")) {%>
											checked <%}%> name="correct<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" readonly="readonly"/><%=innerlist.get(6)%><br />
...
<script>
	$(function() {
		...
		$("#slidemarksscore"+<%=innerlist.get(8)+i%>+"_"+<%=innerlist.get(1)%>+"").html($("#sliderscore"+<%=innerlist.get(8)+i%>+"_"+<%=innerlist.get(1)%>).slider("value"));
						...
						<div id="marksscore<%=innerlist.get(8)+i%>_<%=innerlist.get(1)%>" style="width:25%;">0 <span style="float:right;"><%=innerlist.get(2)%></span></div>
									</div>
 ...
 %>
									<div>
										<textarea rows="5" cols="50" name="<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" style="width:100%" readonly="readonly"><%=innerMp.get("ANSWER") != null ? innerMp.get("ANSWER") : ""%></textarea>
										<br />
										<input type="hidden" name="outofmarks<%=innerlist.get(1)%>_<%=innerlist.get(2)%>"
											id="outofmarks<%=innerlist.get(8)+i%>_<%=innerlist.get(1)%>" value="<%=innerlist.get(2)%>" />
...
<script>
	$(function() {
		...
		$("#slidemarkssingleopen"+<%=innerlist.get(8)+i%>+"_"+<%=innerlist.get(1)%>+"").html($("#slidersingleopen"+<%=innerlist.get(8)+i%>+"_"+<%=innerlist.get(1)%>).slider("value"));
						...
						<div id="markssingleopen<%=innerlist.get(8)+i%>_<%=innerlist.get(1)%>" style="width:25%;">0 <span style="float:right;"><%=innerlist.get(2)%></span></div>
									</div> 
 ...
 %>
									<div>
										...
										<div>
											<textarea rows="5" cols="50" name="a<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" style="width:100%" readonly="readonly"><%=a != null ? a[0] : ""%></textarea>
											<br />
										</div>
										<div style="float: left; margin: 30px 10px 0px 0px;">b)
										</div>
										<div>
											<textarea rows="5" cols="50" name="b<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" style="width:100%" readonly="readonly"><%=a != null ? a[1] : ""%></textarea>
											<br />
										</div>
										<div style="float: left; margin: 30px 10px 0px 0px;">c)
										</div>
										<div>
											<textarea rows="5" cols="50" name="c<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" style="width:100%" readonly="readonly"><%=a != null ? a[2] : ""%></textarea>
											<br />
										</div>
										<div style="float: left; margin: 30px 10px 0px 0px;">d)
										</div>
										<div>
											<textarea rows="5" cols="50" name="d<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" style="width:100%" readonly="readonly"><%=a != null ? a[3] : ""%></textarea>
											<br />
										</div>
...
<script>
	$(function() {
		...
		$("#slidemarksmultipleopen"+<%=innerlist.get(8)+i%>+"_"+<%=innerlist.get(1)%>+"").html($("#slidermultipleopen"+<%=innerlist.get(8)+i%>+"_"+<%=innerlist.get(1)%>).slider("value"));
						...
						<div id="marksmultipleopen<%=innerlist.get(8)+i%>_<%=innerlist.get(1)%>" style="width:25%;">0 <span style="float:right;"><%=innerlist.get(2)%></span></div>
 ...
 %>
									...
									name="gradewithrating<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" /> <script
