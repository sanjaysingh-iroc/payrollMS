								...
								<li>
									...
									<div>
										a) <input type="checkbox" value="a" name="correct<%=innerlist.get(1)%>_<%=innerlist.get(2)%>"
											...
											checked <%}%> disabled="disabled"/><%=innerlist.get(4)%><br /> 
										b) <input type="checkbox" name="correct<%=innerlist.get(1)%>_<%=innerlist.get(2)%>"
											...
											checked <%}%> value="b" disabled="disabled"/><%=innerlist.get(5)%><br />
										...
										c) <input type="checkbox" value="c" name="correct<%=innerlist.get(1)%>_<%=innerlist.get(2)%>"
											...
											checked <%}%> disabled="disabled"/><%=innerlist.get(6)%><br /> 
										d) <input type="checkbox" name="correct<%=innerlist.get(1)%>_<%=innerlist.get(2)%>"
											...
											checked <%}%> value="d" disabled="disabled"/><%=innerlist.get(7)%><br />
 ...
 %>
									<div>
										a) <input type="checkbox" value="a" <%if (innerMp.get("ANSWER") != null && innerMp.get("ANSWER").contains("a")) {%>
											checked <%}%> name="correct<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" disabled="disabled"/><%=innerlist.get(4)%><br />
										...
										c) <input type="checkbox" value="c" <%if (innerMp.get("ANSWER") != null && innerMp.get("ANSWER").contains("c")) {%>
											checked <%}%> name="correct<%=innerlist.get(1)%>_<%=innerlist.get(2)%>" disabled="disabled"/><%=innerlist.get(6)%><br />

										d) <input type="checkbox" name="correct<%=innerlist.get(1)%>_<%=innerlist.get(2)%>"
											<%if (innerMp.get("ANSWER") != null && innerMp.get("ANSWER").contains("d")) {%>
											checked <%}%> value="d" disabled="disabled"/><%=innerlist.get(7)%>
									</div>
 		...
 		if(!answerTypeList.contains("12")){		
			...
			<%}%>
				...
				<%-- <div style="float: right";>
					<s:submit value="Submit" cssClass="input_button" name="btnfinish" onclick="return confirm('Are you sure, you want to submit this ?')"></s:submit>
				</div> --%>
