...
<script type="text/javascript" charset="utf-8">
	...
	function submitForm(type){
		...
		if(type == '1') {
			...
			data = $("#frmProjectWiseEmployeeProgress").serialize();
		}
		$("#actionResult").html('<div id="the_div"><div id="ajaxLoadImage"></div></div>');
		$.ajax({
			type : 'POST',
			url: 'ProjectWiseEmployeeProgress.action',
			data: data,
...
%>
	...
	<div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
		<div class="desgn" style="margin-bottom: 5px;color:#232323;">
            <div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE; margin-top: 10px;">
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                    <s:form name="frmProjectWiseEmployeeProgress" id="frmProjectWiseEmployeeProgress" action="ProjectWiseEmployeeProgress" theme="simple">
        ...
        <display:table name="reportList" cellspacing="1" class="table table-bordered" id="lt1">
        	...
        	<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Client Name"><%=((java.util.List) pageContext.getAttribute("lt1")).get(1)%></display:column>
        	<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Project"><%=((java.util.List) pageContext.getAttribute("lt1")).get(2)%></display:column>
        	...
        	<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Status(Open/Close)"><%=((java.util.List) pageContext.getAttribute("lt1")).get(4)%></display:column>
        	<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Employee"><%=((java.util.List) pageContext.getAttribute("lt1")).get(5)%></display:column>
