...
function submitForm(type){
	document.frmOutstandingReport.exportType.value='';
	var data = "";
	if(type == '1') {
		...
		data = $("#frmOutstandingReport").serialize();
	}
	$("#actionResult").html('<div id="the_div"><div id="ajaxLoadImage"></div></div>');
	$.ajax({
		type : 'POST',
		url: 'OutstandingReport.action',
		data: data,
...
%>
	...
	<div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
		<div class="desgn" style="margin-bottom: 5px;color:#232323;">
            <div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE; margin-top: 10px;">
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                    <s:form name="frmOutstandingReport" id="frmOutstandingReport" action="OutstandingReport" theme="simple">
		...
		<display:table name="alOuter" cellspacing="1" class="table table-bordered" id="lt1">
			...
			<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Invoice No."><%=((java.util.List) pageContext.getAttribute("lt1")).get(0)%></display:column>
			...
			<display:column style="text-align:left; width: 20%;" valign="top" title="Client Name"><%=((java.util.List) pageContext.getAttribute("lt1")).get(2)%></display:column>	
			<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Cost Center"><%=((java.util.List) pageContext.getAttribute("lt1")).get(3)%></display:column>	
			...
			<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Work Location"><%=((java.util.List) pageContext.getAttribute("lt1")).get(5)%></display:column>	
			<display:column style="text-align:left; width: 25%;" valign="top" title="Narration"><%=((java.util.List) pageContext.getAttribute("lt1")).get(6)%></display:column>	
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Invoice Amount"><%=((java.util.List) pageContext.getAttribute("lt1")).get(7)%></display:column>	
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Amount Received"><%=((java.util.List) pageContext.getAttribute("lt1")).get(8)%></display:column>	
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Outstanding Amount"><%=((java.util.List) pageContext.getAttribute("lt1")).get(9)%></display:column>	
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Due On"><%=((java.util.List) pageContext.getAttribute("lt1")).get(10)%></display:column>	
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Overdue by"><%=((java.util.List) pageContext.getAttribute("lt1")).get(11)%></display:column>	
