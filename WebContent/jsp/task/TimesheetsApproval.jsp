            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <% if(strUserType!=null && !strUserType.equals(IConstants.CUSTOMER)) { %>
                    	<li <% if(callFrom == null || callFrom.equals("")) { %> class="active" <% } %>><a href="javascript:void(0)" onclick="getTimesheetsApprovalPage('ProjectTimesheets','');" data-toggle="tab">Unapproved</a></li>
