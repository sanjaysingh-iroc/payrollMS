...
<s:form action="ProjectPerformanceOverallCP" name="frmProPerformance" id="idProProPerformance" theme="simple">
		...
		<%} %>
			...
			<table class="tb_style">	
				...
				<tr>
					...
					<th width="10%">Indicator</th>
					<th width="10%">Project Margin<br/>(%)</th>
					<th width="10%">Gross Profit<br/>(<%=CF.getStrCURRENCY_SHORT() %>)</th> 
					<th width="10%">Billed Amount<br/>(<%=CF.getStrCURRENCY_SHORT() %>)</th>
					<th width="10%">Actual Cost<br/>(<%=CF.getStrCURRENCY_SHORT() %>)</th>
					<!-- <td width="5%" style="border: 0px solid #fff">&nbsp;</td>
...
<div style="margin:2px;float:left;width:100%">
    <div style="width: 20px;float:left"> <i class="fa fa-circle" aria-hidden="true" style="color:#54aa0d"></i><!-- <img src="images1/icons/approved.png" width="17"> --></div> 
