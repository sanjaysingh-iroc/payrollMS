...
function submitForm(type) {
	...
	if(type == '1') {
		...
		data = $("#frmClientOutstandingReport").serialize();
	}
	$("#actionResult").html('<div id="the_div"><div id="ajaxLoadImage"></div></div>');
	$.ajax({
		type : 'POST',
		url: 'ClientOutstandingReport.action',
		data: data,
...
$(function(){
	...
	<div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
		<div class="desgn" style="margin-bottom: 5px;color:#232323;">
            <div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE; margin-top: 10px;">
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                    <s:form name="frmClientOutstandingReport" id="frmClientOutstandingReport" action="ClientOutstandingReport" theme="simple">
		...
		<display:table name="alOuter" cellspacing="1" class="table table-bordered" id="lt1">	
			...
			<display:column style="text-align:left;" valign="top" title="Project Name"><%=((java.util.List) pageContext.getAttribute("lt1")).get(1)%></display:column>	
			...
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Due Date"><%=((java.util.List) pageContext.getAttribute("lt1")).get(4)%></display:column>	
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Billed Outstanding" ><%=((java.util.List) pageContext.getAttribute("lt1")).get(5)%></display:column>	
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Non Billed Outstanding" ><%=((java.util.List) pageContext.getAttribute("lt1")).get(6)%></display:column>	
		
		<%-- <display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Due Date"><%=((java.util.List) pageContext.getAttribute("lt1")).get(3)%></display:column>
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Amount"><%=((java.util.List) pageContext.getAttribute("lt1")).get(3)%></display:column>
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Bill Raised Outstanding Amount" sort="true"><%=((java.util.List) pageContext.getAttribute("lt1")).get(3)%></display:column>
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Bill Not Raised Outstanding Amount" sort="true"><%=((java.util.List) pageContext.getAttribute("lt1")).get(3)%></display:column>	 --%>
			<!-- sort="true" -->
		</display:table>
