...
<jsp:include page="../common/SubHeader.jsp">
	<jsp:param value="Profitability By Service" name="title"/>
</jsp:include>
...
<s:form action="ProfitabilityByService" name="frmProPerformance" id="idProProPerformance" theme="simple">
...
<display:table name="alOuter" cellspacing="1" class="tb_style" export="true"
	pagesize="50" id="lt1" requestURI="ProfitabilityByService.action" width="90%">
	...
	<display:column nowrap="nowrap" title="Service Name"><%=((java.util.List) pageContext.getAttribute("lt1")).get(1)%></display:column>
