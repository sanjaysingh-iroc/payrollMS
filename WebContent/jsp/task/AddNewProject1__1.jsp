				...
				<table border="0" class="table table_no_border">
					...
					<tr>
						...
						<td colspan="2" id="clientPocTD">
							<s:select theme="simple" name="clientPoc" id="clientPoc" listKey="clientPocId" listValue="clientPocName" headerKey="" 
								headerValue="Select SPOC" cssClass="validateRequired" list="clientPocList" />
						</td>
					</tr>
					...
					<tr>
						...
						<td><s:select name="strProjectOwner" id="strProjectOwner" listKey="employeeId" cssClass="validateRequired" headerKey=""
								headerValue="Select Project Owner" listValue="employeeName" list="projectOwnerList" onchange="getProjectOrgDetails(this.value);" /></td>
					</tr>
					<tr>
					...
					<% } else { %>
						...
						<tr id="idFBillingAmount"
							...
							<td>
								<div style="float: left;">
									<s:textfield cssClass="validateRequired" name="billingAmountF" id="billingAmountF" required="true" onkeyup="calBillingAmount();" />
						...
						<tr>
							...
							<td><s:textfield name="estimatedHours" required="true" /></td>
							<td></td>
							<td></td>
						</tr>
						<tr>
...
<s:if test="step==2">
	...
	jQuery(document).ready(function() {
    	...
    	alert("projectId ===>> "+document.getElementById("projectId").value);
		getTeam();
	});
...
<s:if test="step==3">
	...
	$(function () {
		...
		<%-- $("#deadline10").datepicker({
			format : 'dd/mm/yyyy', minDate:"<%=request.getAttribute("PROJECT_START_DATE_MM_DD")%>", maxDate: "<%=request.getAttribute("PROJECT_END_DATE_MM_DD")%>",
