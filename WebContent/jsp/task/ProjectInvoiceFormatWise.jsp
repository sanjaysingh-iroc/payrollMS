...
//System.out.println("CURRENCY_ID ===>> " + hmProjectDetails.get("CURRENCY_ID"));
		...
		if (xmlhttp == null) {
			...
			var xhr = $.ajax({
				...
				success : function(data) {
					...
					//ownerLocationTelDiv ownerLocationFaxDiv ownerLocationPanDiv ownerLocationRegNoDiv ownerLocationECC1Div ownerLocationECC2Div
    	...
    	<table id="INRCurrencyTable" style="display: block; width: 99%;"> 
			...
			<tr id="BillPeriodTR" style="display: none;">
				...
				(Billing period taken as <s:textfield name="strStartDate" id="strStartDate" cssStyle="width:65px" cssClass="validateRequired"></s:textfield>
				 - <s:textfield name="strEndDate"  id="strEndDate" cssStyle="width:65px" cssClass="validateRequired" />)
				</td>
				<td style="border-right: 1pt solid black;">&nbsp;</td> 
				<td style="border-right: 1pt solid black;">&nbsp;</td> 
			</tr>
			...
			<tr>
				...
				<% if(i==0) { %> value="<%=(String)request.getAttribute("remainAmt") %>" <% } %> /></div>
				</td>
				<td style="border-right: 1pt solid black;">&nbsp;</td> 
			</tr>
			<% 
			...
			<tr>
				...
				<div style="margin-bottom: 5px;"><input type="text" name="strParticularsAmt" id="strParticularsAmt0" style="width:65px;text-align:right;" onkeyup="calAmt();" onkeypress="return isNumberKey(event)" class="validateRequired" value="<%=(String)request.getAttribute("remainAmt") %>"/></div>
				</td>
				<td style="border-right: 1pt solid black;">&nbsp;</td> 
			</tr>
		...
		<table id="otherCurrencyTable" style="display: none; width: 99%;"> 
			...
			<tr>
				...
				<td style="border-right: 1pt solid black;text-align:right; padding-right: 5px;" id="particularsAmtINRCurrID">
				 <div style="margin-bottom: 5px;"><input type="text" name="strParticularsAmtINRCurr" id="strParticularsAmtINRCurr0" style="width:65px;text-align:right;" onkeyup="calAmtOtherCurr();" onkeypress="return isNumberKey(event)" class="validateRequired" value="<%=(String)request.getAttribute("remainAmt") %>"/></div>
				</td>
