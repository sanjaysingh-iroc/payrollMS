...
function submitForm(type){
	document.frmEmployeeCostReport.exportType.value='';
	var data = "";
	if(type == '1') {
		var f_org = document.getElementById("f_org").value;
		data = 'f_org='+f_org;
	} else if(type == '2') {
		data = $("#frmEmployeeCostReport").serialize();
	}
	$("#actionResult").html('<div id="the_div"><div id="ajaxLoadImage"></div></div>');
	$.ajax({
		type : 'POST',
		url: 'EmployeeCostReport.action',
		data: data,
...
$(function(){
		...
		<div class="desgn" style="margin-bottom: 5px;color:#232323;">
            <div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE; margin-top: 10px;">
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                    <s:form name="frmEmployeeCostReport" id="frmEmployeeCostReport" action="EmployeeCostReport" theme="simple">
	...
	<%-- <display:table name="alOuter" cellspacing="1" class="tb_style" export="true" pagesize="50" id="lt1" requestURI="EmployeeCostReport.action" width="100%"> --%>
		...
		<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Total Cost"><%=((java.util.List) pageContext.getAttribute("lt1")).get(4)%></display:column>
		 <!-- sort="true" -->
	</display:table>
