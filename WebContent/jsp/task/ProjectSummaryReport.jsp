...
function submitForm(type){
	document.frmProjectSummaryReport.exportType.value='';
	var data = "";
	if(type == '1') {
		...
		data = $("#frmProjectSummaryReport").serialize();
	} else if(type == '3') {
		data = $("#frmProjectSummaryReport").serialize();
	...
	$.ajax({
		type : 'POST',
		url: 'ProjectSummaryReport.action',
		data: data,
...
%>
	...
	<div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
		<div class="desgn" style="margin-bottom: 5px;color:#232323;">
            <div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE; margin-top: 10px;">
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                    <s:form name="frmProjectSummaryReport" id="frmProjectSummaryReport" action="ProjectSummaryReport" theme="simple">
		...
		<display:table name="alOuter" cellspacing="1" class="table table-bordered" id="lt1">
			<display:column style="text-align:left; width: 20%;" valign="top" title="Company Name"><%=((java.util.List) pageContext.getAttribute("lt1")).get(1)%></display:column>
			<display:column style="text-align:left; width: 20%;" valign="top" title="Department Name"><%=((java.util.List) pageContext.getAttribute("lt1")).get(2)%></display:column>	
			<display:column style="text-align:left; width: 20%;" valign="top" title="Name of Client"><%=((java.util.List) pageContext.getAttribute("lt1")).get(3)%></display:column>	
			<display:column style="text-align:left; width: 20%;" valign="top" title="Project Name"><%=((java.util.List) pageContext.getAttribute("lt1")).get(4)%></display:column>	
			<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="No. of Tasks"><%=((java.util.List) pageContext.getAttribute("lt1")).get(5)%></display:column>
			<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="No. of Resources"><%=((java.util.List) pageContext.getAttribute("lt1")).get(6)%></display:column>
		</display:table>
