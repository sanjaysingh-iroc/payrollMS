...
function submitForm(type){
	document.frmProjectHealthReport.exportType.value='';
	var data = "";
	if(type == '1') {
		...
		data = $("#frmProjectHealthReport").serialize();
	} else if(type == '3') {
		data = $("#frmProjectHealthReport").serialize();
	...
	$.ajax({
		type : 'POST',
		url: 'ProjectHealthReport.action',
		data: data,
...
String projectHelthType = (String) request.getAttribute("projectHelthType");
...
//System.out.println("projectHelthType ===>> " + projectHelthType);
%>
	...
	<div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
		<div class="desgn" style="margin-bottom: 5px;color:#232323;">
            <div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE; margin-top: 10px;">
                ...
                <div class="box-body" style="padding: 5px; overflow-y: auto; display:none;">
                    <s:form name="frmProjectHealthReport" id="frmProjectHealthReport" action="ProjectHealthReport" theme="simple">
						...
						<div class="row row_without_margin" style="margin-top: 10px;">
							<div class="col-lg-11 col-md-11 col-sm-12 paddingleft0 paddingright0">
								<div class="col-lg-2 col-md-6 col-sm-12 autoWidth paddingleftright5">
									<input type="radio" name="projectHelthType" id="projectHelthType" value="2" <%=(uF.parseToInt(projectHelthType) == 0 || uF.parseToInt(projectHelthType)== 2) ? "checked" : "" %> onclick="submitForm(this.value)" />Taskwise
									<input type="radio" name="projectHelthType" id="projectHelthType" value="3" <%=(uF.parseToInt(projectHelthType) == 3) ? "checked" : "" %> onclick="submitForm(this.value)" />Resourcewise
								</div>
							</div>
						</div>
                    </s:form>
		...
		<display:table name="alOuter" cellspacing="1" class="table table-bordered" id="lt1">
			...
			<display:column style="text-align:left; width: 25%;" valign="top" title="Project"><%=((java.util.List) pageContext.getAttribute("lt1")).get(1)%></display:column>	
			<display:column style="text-align:left; width: 35%;" valign="top" title="Task"><%=((java.util.List) pageContext.getAttribute("lt1")).get(2)%></display:column>	
			<% if(uF.parseToInt(projectHelthType) == 3) { %>
				<display:column style="text-align:left; width: 35%;" valign="top" nowrap="nowrap" title="Resource"><%=((java.util.List) pageContext.getAttribute("lt1")).get(4)%></display:column>
			<% } %>	
			<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Planned Time"><%=((java.util.List) pageContext.getAttribute("lt1")).get(5)%></display:column>	
			<display:column style="text-align:left;" valign="top" nowrap="nowrap" title="Actual Worked Time"><%=((java.util.List) pageContext.getAttribute("lt1")).get(6)%></display:column>	
			<display:column style="text-align:right;" valign="top" nowrap="nowrap" title="Variance"><%=((java.util.List) pageContext.getAttribute("lt1")).get(7)%></display:column>	
