...
<div class="leftbox reportWidth">
	<!-- <div class="pagetitle" align="center" style="margin: 0px;">Approved
		Project Details</div>
	<br /> -->
	<s:form action="ViewApprovedProject" name="frm" method="post" theme="simple">
		...
		<div class="filter_div">
			...
			<div
				...
				<s:select name="pro_id" id="pro_id" listKey="projectID" listValue="projectName" list="projectdetailslist" key=""
					multiple="true" />
			</div>
			...
			<div
				...
				<s:select theme="simple" name="managerId" id="managerId" listKey="employeeId" listValue="employeeName" list="managerList"
					key="" multiple="true" />
			</div>
			...
			<div
				...
				<s:select label="Select Client" name="client" id="client" listKey="clientId" listValue="clientName" list="clientList" key=""
					multiple="true" />
			</div>
			...
			<div
				...
				<s:select theme="simple" label="Select Skill" name="skill" id="skill" listKey="skillsId" listValue="skillsName"
		...
		<%
			if (index != null && al != null && index.size() != 0 && al.size() != 0) {
		%>
		<br>
...
<!-- 				<th>Task Status</th> -->
			...
			<%
				List<List<String>> oIn = activityDetailMap .get(index.get(i));
						if (oIn != null) {
