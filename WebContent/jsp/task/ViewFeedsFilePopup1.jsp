...
//(function($){
	$.fn.gdocsViewer = function(options) {
		...
		return this.each(function() {
			...
			if (/^(tiff|pdf|ppt|pptx|pps|doc|docx|txt|xls|xlsx|pptx)$/.test(ext)) {
				$(this).after(function () {
					var id = $(this).attr('id');
					var gdvId = (typeof id !== 'undefined' && id !== false) ? id + '-gdocsviewer' : '';
					return '<div id="' + gdvId + '" class="gdocsviewer" style="width:98%; height: 450px;"><iframe src="https://docs.google.com/viewer?embedded=true&url=' + encodeURIComponent(file) + '"  style="width:98%; height: 450px; border: none;margin : 0 auto; display : block;"></iframe></div>';
				})
			}
