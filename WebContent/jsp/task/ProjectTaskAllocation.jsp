...
<table class="table table-bordered">
	...
	<tr>
		...
		<td class="alignRight padRight20" valign="top"><%=alInner.get(3) %></td>
		<td class="alignRight padRight20" valign="top"><%=alInner.get(4) %></td>
		<td class="alignRight padRight20" valign="top"><%=alInner.get(5) %></td>
		<td class="alignRight padRight20" valign="top"><%=alInner.get(6) %></td>
		<td class="alignRight padRight20" valign="top"><%=alInner.get(7) %></td>
	</tr>
	<% } %>
