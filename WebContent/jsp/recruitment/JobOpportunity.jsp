...
$(document).ready(function() {
	/* Created by Dattatray Date:20-09-21 Note : changed div to span */
  $('span.expandDiv').expander({
			...
			<s:form name="frm_JobOpportunity" id="frm_JobOpportunity" action="JobOpportunities" theme="simple">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 no-padding">
		       	...
		       	<div style="line-height: 22px; float: right; font-size: 12px; margin-right: 45px;">
		       		<a href="AddCandidateByCadi.action" target="_blank" ><input type="button" name="applyFresherJob" id="applyFresherJob" class="btn btn-primary" value="Job Application"/></a> <!-- onclick="window.location='AddCandidateByCadi.action'"  -->
	...
	<% if(uF.parseToInt(strRecruitId) > 0) { %>
		...
		<%
			...
			<div class="col-lg-12 col-md-12 col-sm-12 jobboxlist">
				<div style="float: left; margin-bottom: 7px; min-height: 250px; margin-left: 15px; margin-top: 2%;">
					<div style="float: left; width: 100%;">
						...
						<!-- ===start parvez on 04-08-2021=== -->
							<%-- <div style="float: left; width: 100%;" id="textlabel">
								<div class="expandDiv">Job Description:<br/><span style="color: gray;"><%=alinner.get(9)%></span></div>
								<span style="float:left;" class="users-list-name"><b>Job Description11122:</b>&nbsp;<%=alinner.get(9)%></span>
							</div> --%>
							<!--  Created By Dattatray Date:20-09-21-->
							<div style="float: left; width: 100%;" id="textlabel"> <div>Job Description:<br/><span style="color: gray;"><%=alinner.get(9)%></span></div></div>
							<!-- ===end parvez on 04-08-2021=== -->
						<div style="float: left; width: 100%;">
							<%-- Essential Skills:&nbsp;<span style="color: gray;"><%=alinner.get(10)%></span> --%>
							<span style="float:left;" class="users-list-name"><b>Essential Skills:</b>&nbsp;<%=alinner.get(10)%></span>
						</div>
						<div style="float: left; width: 100%;">
		...
		<div class="col-lg-5 col-md-5 col-sm-5">
			...
			%>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 jobboxlist">
					<div style="float: left; width: 100%; margin-bottom: 7px; margin-left: 15px;margin-top: 2%;">
						<div style="float: left; width: 100%;">
							...
							<!-- ===start parvez on 04-08-2021=== -->
							<div style="float: left; width: 100%;" id="textlabel"><%-- <div class="expandDiv">Job Description:<br/><span style="color: gray;"><%=alinner.get(9)%></span></div> --%>
								<!-- Created By Dattatray Date : 20-09-21 Note :width set -->
								<span style="float:left;width: 100%;" class="users-list-name"><b>Job Description:</b>&nbsp;<a href="JobOpportunities.action?RecrtNm=<%=sb.toString() %>&strRecruitId=<%=alinner.get(0) %>" ><%=alinner.get(9)%></a></span>
							</div>
							<!-- ===end parvez on 04-08-2021=== -->
							<div style="float: left; width: 100%;"><%-- Essential Skills:&nbsp;<span style="color: gray;"><%=alinner.get(10)%></span> --%>
							<span style="float:left;width: 100%;" class="users-list-name"><b>Essential Skills:</b>&nbsp;<a href="JobOpportunities.action?RecrtNm=<%=sb.toString() %>&strRecruitId=<%=alinner.get(0) %>" ><%=alinner.get(10)%></a></span>
							</div>
							<div style="float: left; width: 100%; ">
								<span style="float:left;width: 100%;">Experience:&nbsp;<span style="color: gray;"><%=uF.showData(alinner.get(11), "0")%>&nbsp;yrs - <%=alinner.get(12)%>&nbsp;yrs</span></span>
				                <%-- <span style="float:left;">Maximum Experience:&nbsp;<span style="color: gray;"><%=alinner.get(12)%>&nbsp;yrs</span></span> --%>
			                </div>
			                <div style="float: left; width: 100%; ">
								<span style="float:left;width: 100%;">Location:&nbsp;<span style="color: gray;"><%=alinner.get(13)%></span></span>
			                </div>
			                <div style="float: left; width: 100%; ">
				                <span style="float:left;width: 100%;">Organization:&nbsp;<span style="color: gray;"><%=alinner.get(14)%></span></span>
		...
		<div class="attendance">
			...
			<script type="text/javascript">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="jobbox" style="overflow-y: auto;height: 250px;">
						<!-- <div style="float: left; margin-bottom: 7px; margin-left: 15px;margin-top: 2%;"> -->
							<div style="float: left; width: 100%;">
								...
								<% } %>
								<!-- ===start parvez on 03-08-2021=== -->
								<!-- /* Start Dattatray Date:20-09-21 Note : added expandDiv class*/ -->
								<div  style="float: left; width: 100%;" id="textlabel">Job Description:<br/><span class="expandDiv" id="jobDesc<%=alinner.get(0) %>" style="color: gray;"><%=alinner.get(9)%></span></div>
								<!-- ===end parvez on 03-08-2021=== -->
								<div style="float: left; width: 100%;">Essential Skills:&nbsp;<span id="skills<%=alinner.get(0) %>" style="color: gray;"><%=alinner.get(10)%></span></div>
								<div style="float: left; width: 100%; ">
									<span style="float:left;">Experience:&nbsp;<span style="color: gray;"><%=uF.showData(alinner.get(11), "0")%>&nbsp;yrs - <%=alinner.get(12)%>&nbsp;yrs</span></span>
