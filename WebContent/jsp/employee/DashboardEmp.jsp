...
<jsp:include page="../common/SubHeader.jsp">
    ...
    <div class="leftbox reportWidth">
        ...
        <div id="left">
			<div id="profilecontainer">
               <div class="holder">
                    ...
                    <img class="lazy img-circle" height="82" width="84" id="profilecontainerimg" style="border:1px solid #CCCCCC;" src="userImages/avatar_photo.png" data-original="<%=CF.getStrDocRetriveLocation()+strImage %>"/>
                    </div>
                    <div>
             ...
             <%
             	...
             	int nLeaveCancelCount = uF.parseToInt((String)request.getAttribute("LEAVE_CANCEL_COUNT")); 
             	int nLeaveCount = uF.parseToInt((String)request.getAttribute("LEAVE_COUNT"));
             ...
             <div id="profilecontainer">
				...
				<div class="content1">
	                ...
	                <%if(request.getAttribute("RESIGNATION_STATUS_D")!=null){ %>
	                <p class="notify">
	                  <span> <%=request.getAttribute("RESIGNATION_STATUS_D") %></span>
	                  <%if(uF.parseToInt((String)request.getAttribute("RESIG_STATUS")) ==1){ %>
						<span style="float:left;color: red;text-align: left;width:100%"><%=uF.showData((String)request.getAttribute("RESIGNATION_REMAINING"), "0") %></span>												
					<%} %>
	                </p>
	                <%} %>
					...
					<%if(nLeaveApprovalCount>0 || nLeaveDeniedCount>0 || nLeavePendingCount>0 || nLeaveCancelCount>0){%>
						 
							<%if(nLeaveCount>0){ %>
								<p class="notify">
									Your <a href="EmployeeLeaveEntryReport.action"><strong><%=nLeaveCount%></strong> leaves have been <font color="green">approved</font></a>
								</p>
							<%} if(nLeaveCancelCount>0){ %>
								<p class="notify">
									Your <a href="EmployeeLeaveEntryReport.action"><strong><%=nLeaveCancelCount%></strong> leaves have been <font color="red">canceled</font></a>
								</p>
							<%}
							 if(nLeaveDeniedCount>0){ %>
								<p class="notify">
									Your <a href="EmployeeLeaveEntryReport.action"><strong><%=nLeaveDeniedCount%></strong> leaves are  <font color="red">denied</font></a>
								</p>
							<%} if(nLeavePendingCount>0){ %>
			                	<p class="notify">
									Your <a href="EmployeeLeaveEntryReport.action"><strong><%=nLeavePendingCount%></strong> leaves are <font color="orange">waiting for approval</font></a>
								</p> 
			                <%} %>
   	...
   	<%if(arrEnabledModules!=null && ArrayUtils.contains(arrEnabledModules, IConstants.MODULE_HUMAN_CAPITAL_MANAGEMENT+"")>=0){ %>
   			<div class="KPI"> 
   			...
   			<div class="KPI"> 
	               ...
	               <div class="content1">
						<div style="height: 200px;width:45%;float:left">
							<jsp:include page="/jsp/chart/AttendanceKPIChart.jsp" />
						</div>
						<div style="height: 200px;width:45%;float:right">
							<jsp:include page="/jsp/chart/ProjectKPIChart.jsp" />
						</div>
...
<!--               
<div style="-moz-border-radius: 5px 5px 5px 5px; background: none repeat scroll 0pt 0pt #EFEFEF; border: 1px solid #999999; left: 97%; position: fixed; top: 45%; width: 30px;padding-left:10px;" class="social_holder">
	<a href="EmployeeLeaveEntryReport.action" title="My Leaves"><img src="images1/icons/myLeaves.png" width="20px"></a>
	<a href="Reimbursements.action" title="My Reimbursements"><img src="images1/icons/myReimsbursements.png" width="20px"></a>
	<a href="AddProjectActivity1.action" title="My Timesheet"><img src="images1/icons/myTimesheet.png" width="20px"></a>
</div>
 -->              
	 </div>  
