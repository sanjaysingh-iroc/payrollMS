...
<%
	...
	if (strMenu == null
			&& strPage
					.equalsIgnoreCase("/jsp/common/ForgotPassword.jsp")) {
		strMenu = "../common/PreMenu.jsp";
	} else if (strMenu == null
			&& !strPage
					.equalsIgnoreCase("/jsp/common/ForgotPassword.jsp")) {
		strPage = "../common/Login.jsp";
	}
	...
	<div id="wrapper">
		<div class="container">
			...
			<div class="leftbox reportWidth">
				<div class="msg_error">
					<span><strong>Unauthorized</strong><br /> User failed to provide a valid</span>
					user name / password required for access to file / directory.
				</div>
			</div>
