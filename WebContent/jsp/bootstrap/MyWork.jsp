...
<html>
  <head>
    ...
    <title>Menu with bootstrap</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Task</b>Rig</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Rahul Patil</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                    <p>
                      Rahul Patil - Java Developer
                      <small>Member since May 2011</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
...
%>
					...
					<%
                              ...
                              for(int i=0; alParentNavL!=null && i<alParentNavL.size(); i++){ 
                            		...
                            		if(uF.parseToInt(n.getStrChild())==0) {
                            			%>
                                        <li class="treeview"><a class="<%=((n.getStrNavId().equalsIgnoreCase(strNavId))?"selectedL":"") %>" href="<%= n.getStrAction()%>">
                                       ...
                                       <% if(n.getStrPosition() != null && !n.getStrPosition().equals("C")) {  %>
                                        ...
                                        <b><%=((n.getStrNavId().equalsIgnoreCase(strNavId) || n.getStrNavId().equalsIgnoreCase(strNavParentId) || n.getStrNavId().equalsIgnoreCase(strNavParentId1))?n.getStrLabelSelected():n.getStrLabelUnSelected()) %></b>
    ...
    <!-- jQuery 2.1.4 -->
    <script src="js_bootstrap/jQuery/jQuery-2.1.4.min.js"></script>
    <!-- Bootstrap 3.3.5 -->
    <script src="bootstrap/js/bootstrap.min.js"></script>
    <!-- FastClick -->
    <script src="js_bootstrap/fastclick/fastclick.min.js"></script>
    <!-- AdminLTE App -->
