...
<div class="leftbox reportWidth" style="font-size: 12px;"> 
	...
	%>
	<s:form id="frmEditGoal" name="frmEditGoal" theme="simple" action="EditMyPersonalGoal_1" method="POST" cssClass="formcss" >
		...
		<table class="table table_no_border">
			...
			<tr>
				...
				<td colspan="3">
					...
					<input type="text" name="corporateGoal" class="validateRequired    form-control " style="width: 600px;" value="<%=innerList.get(3)%>" />
				</td>
			</tr>
			<tr>
		...
		<%} %>
			...
			<%if(typeas !=null && typeas.equals("KRA")){ %>
				<%-- <tr>
					...
					<td colspan="3">
						<span id="perspectiveDiv" style=" float: left; padding-left: 10px;">
					 		<select name="perspectiveYesno" id="perspectiveYesno"  class=" validateRequired">
							  <%=innerList.get(45) %>
							</select> 
