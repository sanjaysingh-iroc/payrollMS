		...
		<table>
			...
			<tr> 
				...
				<td><s:select theme="simple" name="strAttribute" list="attributeList" listKey="id"
                                        ...
                                        headerValue="select Attribute" required="true" cssClass="validateRequired"/></td>
			</tr>
			<tr>
				...
				<td><s:select theme="simple" name="strLevel" list="levelList" listKey="levelId"
                                        ...
                                        headerValue="select Level" required="true" cssClass="validateRequired"/></td>
			</tr>
			<tr>
