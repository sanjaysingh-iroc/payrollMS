	...
	<% } %>
				...
				<div class="box-body" style="padding: 5px; overflow-y: auto;min-height: 600px;">
	                ...
	                <div id="MainDiv" class="row" style="margin-left: 0px;margin-right: 0px;"> 
						...
						<div class="col-lg-3 col-md-3 col-sm-12" style="padding: 2px; overflow-y: hidden; max-height: 500px;" id="leftSectionTeamKPI"><!-- Start Dattatray -->
						...
						<!-- Start Dattatray -->
						<div class="col-lg-9 col-md-9 col-sm-12" style="overflow-y: hidden;max-height: 500px;" id="rightSectionTeamKPI">
						<div id="teamKPIs" ></div>
						</div>
						<!-- End Dattatray -->
					</div>
...
$(window).bind('mousewheel DOMMouseScroll', function(event){
    if (event.originalEvent.wheelDelta > 0 || event.originalEvent.detail < 0) {
        // scroll up
        if($(window).scrollTop() == 0 && $("#leftSectionTeamKPI").scrollTop() != 0) {
        	$("#leftSectionTeamKPI").scrollTop($("#leftSectionTeamKPI").scrollTop() - 30);
        }
        if($(window).scrollTop() == 0 && $("#rightSectionTeamKPI").scrollTop() != 0) {
        	$("#rightSectionTeamKPI").scrollTop($("#rightSectionTeamKPI").scrollTop() - 30);
        }
    } else {
        // scroll down
...
$(window).keydown(function(event){
	if(event.which == 40 || event.which == 34){
		if($(window).scrollTop() + $(window).height() > $(document).height() - 15) {
			$("#leftSectionTeamKPI").scrollTop($("#leftSectionTeamKPI").scrollTop() + 50);
   		}
		if($(window).scrollTop() + $(window).height() > $(document).height() - 15) {
			$("#rightSectionTeamKPI").scrollTop($("#rightSectionTeamKPI").scrollTop() + 50);
   		}
