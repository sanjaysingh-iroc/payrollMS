...
<script>
	$(function () {
		$("input[type='submit']").click(function(){
			$("#formEditQuestionDetails").find('.validateRequired').filter(':hidden').prop('required',false);
			$("#formEditQuestionDetails").find('.validateRequired').filter(':visible').prop('required',true);
		});
	});
...
<%
	...
	//System.out.println("jsp fromPage==>"+fromPage);
...
<div id="mainDiv" style="float: left; margin: 10px 0px 0px 0px; width: 100%;">
	<s:form action="AddMyReviewEditQuestionDetails" id="formEditQuestionDetails" name="formEditQuestionDetails" method="POST" theme="simple">
	...
	%>
				...
				<li>
					 <table class="table table_no_border" style="width: 100%;">
						...
						<tr>
							...
							<td>
							<input type="text" name="scoreCardWeightage" id="scoreCardWeightage<%=counter%>" class="validateNumber" onkeypress="return isNumberKey(event)" value="<%=scoreInnerList.get(3)%>" onkeyup="validateScoreEdit(this.value,'scoreCardWeightage<%=counter%>','hidescoreCardWeightage<%=counter%>','<%=request.getAttribute("totWeightage") %>')"/>
						...
						<li>
							 <table class="table table_no_border" style="width: 100%;">
								...
								<tr>
									<th style="text-align: right;">Weightage %<sup>*</sup></th>
									<td>
									<input type="text" name="goalWeightage" id="goalWeightage<%=counter%>" class="validateNumber" value="<%=goalInnerList.get(3)%>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'goalWeightage<%=counter%>','hidegoalWeightage<%=counter%>','<%=CGOMtotSGoalWeight %>')"/>
								...
								<li>
									 <table class="table table_no_border" style="width: 100%;">
										...
										<tr>
											<th style="text-align: right;">Weightage %<sup>*</sup></th>
											<td>
											<input type="text" name="objectiveWeightage" id="objectiveWeightage<%=counter%>" class="validateNumber" value="<%=objectiveInnerList.get(3)%>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'objectiveWeightage<%=counter%>','hideobjectiveWeightage<%=counter%>','<%=CGOMtotSObjectiveWeight %>')"/>
										...
										<li>
											 <table class="table table_no_border" style="width: 100%;">
												...
												<tr>
													<th style="text-align: right;">Weightage %<sup>*</sup></th>
													<td>
													<input type="text" name="measureWeightage" id="measureWeightage<%=counter%>" class="validateNumber" onkeypress="return isNumberKey(event)"  value="<%=measureMpInnerList.get(3)%>" onkeyup="validateScoreEdit(this.value,'measureWeightage<%=counter%>','hidemeasureWeightage<%=counter%>','<%=CGOMtotSMeasureWeight %>')"/>
											...
											<ul>
												...
												<%-- <th><%=a+1%>.<%=i+1%>.1)</th> --%>
													...
													<th width="17%" style="text-align: right;">Add Question<sup>*</sup>
														...
														<input type="text" style="width: 35px!important;" name="weightage" id="weightage<%=counter %>" class="validateNumber" onkeypress="return isNumberKey(event)" value="<%=questionMpInnerList.get(1) %>" onkeyup="validateScoreEdit(this.value,'weightage<%=counter%>','hideweightage<%=counter%>','<%=CGOMtotSQueWeight %>')"/>
														<input type="hidden" name="hideweightage" id="hideweightage<%=counter %>" value="<%=questionMpInnerList.get(1) %>" />
														</span>
														<span style="float: left; margin-left: 10px;"><a href="javascript:void(0)" title="Select from Question Bank" onclick="openQuestionBank('<%=counter %>');" > +Q </a></span>
														<span id="checkboxspan<%=counter %>" style="float: left; margin-left: 10px;">
															<input name="addFlag" type="checkbox" id="addFlag<%=counter %>" <%if(questionMpInnerList.get(10) != null && uF.parseToBoolean(questionMpInnerList.get(10))){%> checked="checked" <%} %> 
															 title="Add to Question Bank" onclick="changeStatus('<%=counter %>')"/>
				...
				<li>
					 <table class="table table_no_border" style="width: 100%;">
						...
						<tr>
							<th style="text-align: right;">Weightage %<sup>*</sup></th>
							<td>
							<input type="text" name="goalWeightage" id="goalWeightage<%=counter %>" class="validateNumber" value="<%=goalInnerList.get(3)%>" onkeypress="return isNumberKey(event)"  onkeyup="validateScoreEdit(this.value,'goalWeightage<%=counter %>','hidegoalWeightage<%=counter %>','<%=request.getAttribute("totWeightage") %>')"/>
							<input type="hidden" name="hidegoalWeightage" id="hidegoalWeightage<%=counter %>" value="<%=goalInnerList.get(3)%>" />
							</td>
						</tr>
					</table>
						...
						<li>
							 <table class="table table_no_border" style="width: 100%;">
								...
								<tr>
									<th style="text-align: right;">Weightage %<sup>*</sup></th>
									<td>
									<input type="text" name="objectiveWeightage" id="objectiveWeightage<%=counter %>" class="validateNumber" value="<%=objectiveInnerList.get(3)%>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'objectiveWeightage<%=counter %>','hideobjectiveWeightage<%=counter %>','<%=CGOMtotGObjectiveWeight %>')"/>
									<input type="hidden" name="hideobjectiveWeightage" id="hideobjectiveWeightage<%=counter %>" value="<%=objectiveInnerList.get(3)%>" />
									</td>
								</tr>
							</table></li>
								...
								<li>
									 <table class="table table_no_border" style="width: 100%;">
										...
										<tr>
											<th style="text-align: right;">Weightage %<sup>*</sup></th>
											<td>
											<input type="text" name="measureWeightage" id="measureWeightage<%=counter %>" class="validateNumber" value="<%=measureMpInnerList.get(3)%>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'measureWeightage<%=counter %>','hidemeasureWeightage<%=counter %>','<%=CGOMtotGMeasureWeight %>')"/>
											<input type="hidden" name="hidemeasureWeightage" id="hidemeasureWeightage<%=counter %>" value="<%=measureMpInnerList.get(3)%>" />
											</td>
										</tr>
									</table>
									...
									<ul>
										...
										<table class="table table_no_border" width="100%">
											...
											<th width="17%" style="text-align: right;">Add Question<sup>*</sup>
												...
												<span style="float: left; margin-left: 10px;"><input type="hidden" name="orientt" value="0"/><sup>*</sup>
												<input type="text" style="width: 35px!important;" name="weightage" id="weightage<%=counter %>" class="validateNumber" value="<%=questionMpInnerList.get(1) %>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'weightage<%=counter %>','hideweightage<%=counter %>','<%=CGOMtotGQueWeight %>')"/>
												<input type="hidden" name="hideweightage" id="hideweightage<%=counter %>" value="<%=questionMpInnerList.get(1) %>" />
												</span>
												<span style="float: left; margin-left: 10px;"><a href="javascript:void(0)" title="Select from Question Bank" onclick="openQuestionBank('<%=counter %>');" > +Q </a></span>
												<span id="checkboxspan<%=counter %>" style="float: left; margin-left: 10px;">
													<input name="addFlag" type="checkbox" <%if(questionMpInnerList.get(10) != null && uF.parseToBoolean(questionMpInnerList.get(10))){%> 
													checked="checked" <%} %> id="addFlag<%=counter %>" title="Add to Question Bank" onclick="changeStatus('<%=counter %>')"/>
												<input type="hidden" id="status<%=counter %>" name="status" value="<%=(questionMpInnerList.get(10) != null && uF.parseToBoolean(questionMpInnerList.get(10))) ? "1" : "0" %>"/></span>
												<%-- <a href="javascript:void(0)" class="add_lvl" title="Add New Question" onclick="getOtherquestion()" ></a>&nbsp;&nbsp;
												<img border="0" style="height: 16px; width: 16px;" src="<%=request.getContextPath()%>/images/close_pop.png" title="Remove Question" onclick="removeOtherquestion('otherQuestionUl<%=a %>_<%=i %>')"/> --%>
												<input type="hidden" name="questiontypename" value="0" /></td>
				...
				<li>
					 <table class="table table_no_border" style="width: 100%;">
						...
						<tr>
							<th style="text-align: right;">Weightage %<sup>*</sup></th>
							<td>
							<input type="text" name="objectiveWeightage" id="objectiveWeightage<%=counter %>" class="validateNumber" onkeypress="return isNumberKey(event)" value="<%=objectiveInnerList.get(3)%>" onkeyup="validateScoreEdit(this.value,'objectiveWeightage<%=counter %>','hideobjectiveWeightage<%=counter %>','<%=request.getAttribute("totWeightage") %>')"/>
							<input type="hidden" name="hideobjectiveWeightage" id="hideobjectiveWeightage<%=counter %>" value="<%=objectiveInnerList.get(3)%>" />
							</td>
						</tr>
					</table></li>
						...
						<li>
							 <table class="table table_no_border" style="width: 100%;">
								...
								<tr>
									<th style="text-align: right;">Weightage %<sup>*</sup></th>
									<td>
									<input type="text" name="measureWeightage" id="measureWeightage<%=counter %>" class="validateNumber" value="<%=measureMpInnerList.get(3)%>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'measureWeightage<%=counter %>','hidemeasureWeightage<%=counter %>','<%=CGOMtotOMeasureWeight %>')"/>
									<input type="hidden" name="hidemeasureWeightage" id="hidemeasureWeightage<%=counter %>" value="<%=measureMpInnerList.get(3)%>" />
									</td>
								</tr>
							</table>
							...
							<ul>
								...
								<table class="table table_no_border" width="100%">
									...
									<th width="17%" style="text-align: right;">Add Question<sup>*</sup>
										...
										<span style="float: left; margin-left: 10px;"><input type="hidden" name="orientt" value="0"/><sup>*</sup>
										<input type="text" style="width: 35px!important;" name="weightage" id="weightage<%=counter %>" class="validateNumber" value="<%=questionMpInnerList.get(1) %>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'weightage<%=counter %>','hideweightage<%=counter %>','<%=CGOMtotOQueWeight %>')"/>
										<input type="hidden" name="hideweightage" id="hideweightage<%=counter %>" value="<%=questionMpInnerList.get(1) %>" />
										</span>
										<span style="float: left; margin-left: 10px;"><a href="javascript:void(0)" title="Select from Question Bank" onclick="openQuestionBank('<%=counter %>');" > +Q </a></span>
										<span id="checkboxspan<%=counter %>" style="float: left; margin-left: 10px;">
										<input name="addFlag" type="checkbox" id="addFlag<%=counter %>" <%if(questionMpInnerList.get(10) != null && uF.parseToBoolean(questionMpInnerList.get(10))){%>
										 checked="checked" <%} %> title="Add to Question Bank" onclick="changeStatus('<%=counter %>')"/>
										<input type="hidden" id="status<%=counter %>" name="status" value="<%=(questionMpInnerList.get(10) != null && uF.parseToBoolean(questionMpInnerList.get(10))) ? "1" : "0" %>"/></span>
										<%-- <a href="javascript:void(0)" class="add_lvl" title="Add New Question" onclick="getOtherquestion()" ></a>&nbsp;&nbsp;
										<img border="0" style="height: 16px; width: 16px;" src="<%=request.getContextPath()%>/images/close_pop.png" title="Remove Question" onclick="removeOtherquestion('otherQuestionUl<%=a %>_<%=i %>')"/> --%>
										<input type="hidden" name="questiontypename" value="0" /></td>
						...
						<li>
							 <table class="table table_no_border" style="width: 100%;">
								...
								<tr>
									<th style="text-align: right;">Weightage %<sup>*</sup></th>
									<td>
									<input type="text" name="measureWeightage" id="measureWeightage<%=counter %>" class="validateNumber" value="<%=measureMpInnerList.get(3)%>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'measureWeightage<%=counter %>','hidemeasureWeightage<%=counter %>','<%=request.getAttribute("totWeightage") %>')"/>
									<input type="hidden" name="hidemeasureWeightage" id="hidemeasureWeightage<%=counter %>" value="<%=measureMpInnerList.get(3)%>" />
									</td>
								</tr>
							</table>
							...
							<ul>
								...
								<table class="table table_no_border" width="100%">
									...
									<th width="17%" style="text-align: right;">Add Question<sup>*</sup>
										...
										<span style="float: left; margin-left: 10px;"><input type="hidden" name="orientt" value="0"/><sup>*</sup>
										<input type="text" style="width: 35px!important;" name="weightage" id="weightage<%=counter %>" class="validateNumber" value="<%=questionMpInnerList.get(1) %>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'weightage<%=counter %>','hideweightage<%=counter %>','<%=CGOMtotMQueWeight %>')"/>
										<input type="hidden" name="hideweightage" id="hideweightage<%=counter %>" value="<%=questionMpInnerList.get(1) %>" />
										</span>
										<span style="float: left; margin-left: 10px;"><a href="javascript:void(0)" title="Select from Question Bank" onclick="openQuestionBank('<%=counter %>');" > +Q </a></span>
										<span id="checkboxspan<%=counter %>" style="float: left; margin-left: 10px;">
			...
			<ul class="">
				...
				<table class="table table_no_border" width="100%">
					...
					<th width="17%" style="text-align: right;">Add Question<sup>*</sup>
						...
						<span style="float: left; margin-left: 10px;"><input type="hidden" name="orientt" value="0"/><sup>*</sup>
						<input type="text" style="width: 35px!important;" name="weightage" id="weightage<%=counter %>"  class="validateNumber" value="<%=questionMpInnerList.get(1) %>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'weightage<%=counter %>','hideweightage<%=counter %>','<%=request.getAttribute("totWeightage") %>')"/>
						<input type="hidden" name="hideweightage" id="hideweightage<%=counter %>" value="<%=questionMpInnerList.get(1) %>" />
						</span>
						<span style="float: left; margin-left: 10px;"><a href="javascript:void(0)" title="Select from Question Bank" onclick="openQuestionBank('<%=counter %>');" > +Q </a></span>
						<span id="checkboxspan<%=counter %>" style="float: left; margin-left: 10px;">
				...
				<li>
					 <table class="table table_no_border" style="width: 100%;">
						...
						<tr>
							<th style="text-align: right;">Weightage %<sup>*</sup></th>
							<td>
							<input type="text" name="scoreCardWeightage" id="scoreCardWeightage<%=counter %>"  class="validateNumber" value="<%=scoreInnerList.get(3)%>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'scoreCardWeightage<%=counter %>','hidescoreCardWeightage<%=counter %>','<%=request.getAttribute("totWeightage") %>')"/>
							<input type="hidden" name="hidescoreCardWeightage" id="hidescoreCardWeightage<%=counter %>" value="<%=scoreInnerList.get(3)%>" />
							</td>
						</tr>
						<%-- <tr>
						...
						<li>
							 <table class="table table_no_border" style="width: 100%;">
								...
								<tr>
									<th style="text-align: right;">Weightage %<sup>*</sup></th>
									<td>
									<input type="text" name="goalWeightage" id="goalWeightage<%=counter %>"  class="validateNumber" value="<%=goalInnerList.get(3)%>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'goalWeightage<%=counter %>','hidegoalWeightage<%=counter %>','<%=CGMtotSGoalWeight %>')"/>
									<input type="hidden" name="hidegoalWeightage" id="hidegoalWeightage<%=counter %>" value="<%=goalInnerList.get(3)%>" />
									</td>
								</tr>
							</table></li>
								...
								<li>
									 <table class="table table_no_border" style="width: 100%;">
										...
										<tr>
											<th style="text-align: right;">Weightage %<sup>*</sup></th>
											<td>
											<input type="text" name="measureWeightage" id="measureWeightage<%=counter %>"  class="validateNumber" value="<%=measureMpInnerList.get(3)%>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'measureWeightage<%=counter %>','hidemeasureWeightage<%=counter %>','<%=CGMtotSMeasureWeight %>')"/>
											<input type="hidden" name="hidemeasureWeightage" id="hidemeasureWeightage<%=counter %>" value="<%=measureMpInnerList.get(3)%>" />
											</td>
										</tr>
									</table></li>
									...
									<ul>
										...
										<%-- <th><%=a+1%>.<%=i+1%>.1)</th> --%>
											...
											<th width="17%" style="text-align: right;">Add Question<sup>*</sup>
												...
												<span style="float: left; margin-left: 10px;"><input type="hidden" name="orientt" value="0"/><sup>*</sup>
												<input type="text" style="width: 35px!important;" name="weightage" id="weightage<%=counter %>" onkeypress="return isNumberKey(event)" class="validateNumber" value="<%=questionMpInnerList.get(1) %>" onkeyup="validateScoreEdit(this.value,'weightage<%=counter %>','hideweightage<%=counter %>','<%=CGMtotSQueWeight %>')"/>
												<input type="hidden" name="hideweightage" id="hideweightage<%=counter %>" value="<%=questionMpInnerList.get(1) %>" />
												</span>
												<span style="float: left; margin-left: 10px;"><a href="javascript:void(0)" title="Select from Question Bank" onclick="openQuestionBank('<%=counter %>');" > +Q </a></span>
												<span id="checkboxspan<%=counter %>" style="float: left; margin-left: 10px;">
				...
				<li>
					 <table class="table table_no_border" style="width: 100%;">
						...
						<tr>
							<th style="text-align: right;">Weightage %<sup>*</sup></th>
							<td>
							<input type="text" name="goalWeightage" id="goalWeightage<%=counter %>" value="<%=goalInnerList.get(3)%>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'goalWeightage<%=counter %>','hidegoalWeightage<%=counter %>','<%=request.getAttribute("totWeightage") %>')"/>
							<input type="hidden" name="hidegoalWeightage" id="hidegoalWeightage<%=counter %>" value="<%=goalInnerList.get(3)%>" />
							</td>
						</tr>
					</table></li>
						...
						<li>
							 <table class="table table_no_border" style="width: 100%;">
								...
								<tr>
									<th style="text-align: right;">Weightage %<sup>*</sup></th>
									<td>
									<input type="text" name="measureWeightage" id="measureWeightage<%=counter %>" onkeypress="return isNumberKey(event)" class="validateNumber" value="<%=measureMpInnerList.get(3)%>" onkeyup="validateScoreEdit(this.value,'measureWeightage<%=counter %>','hidemeasureWeightage<%=counter %>','<%=CGMtotGMeasureWeight %>')"/>
							...
							<ul>
								...
								<%-- <th><%=a+1%>.<%=i+1%>.1)</th> --%>
									...
									<th width="17%" style="text-align: right;">Add Question<sup>*</sup>
										...
										<span style="float: left; margin-left: 10px;"><input type="hidden" name="orientt" value="0"/><sup>*</sup>
										<input type="text" style="width: 35px!important;" name="weightage" id="weightage<%=counter %>" class="validateNumber" onkeypress="return isNumberKey(event)" value="<%=questionMpInnerList.get(1) %>" onkeyup="validateScoreEdit(this.value,'weightage<%=counter %>','hideweightage<%=counter %>','<%=CGMtotGQueWeight %>')"/>
										<input type="hidden" name="hideweightage" id="hideweightage<%=counter %>" value="<%=questionMpInnerList.get(1) %>" />
										</span>
										<span style="float: left; margin-left: 10px;"><a href="javascript:void(0)" title="Select from Question Bank" onclick="openQuestionBank('<%=counter %>');" > +Q </a></span>
										<span id="checkboxspan<%=counter %>" style="float: left; margin-left: 10px;">
				...
				<li>
					 <table class="table table_no_border" style="width: 100%;">
						...
						<tr>
							<th style="text-align: right;">Weightage %<sup>*</sup></th>
							<td>
							<input type="text" name="measureWeightage" id="measureWeightage<%=counter %>" onkeypress="return isNumberKey(event)" class="validateNumber" value="<%=measureMpInnerList.get(3)%>" onkeyup="validateScoreEdit(this.value,'measureWeightage<%=counter %>','hidemeasureWeightage<%=counter %>','<%=request.getAttribute("totWeightage") %>')"/>
							<input type="hidden" name="hidemeasureWeightage" id="hidemeasureWeightage<%=counter %>" value="<%=measureMpInnerList.get(3)%>" />
							</td>
						</tr>
					</table></li>
					...
					<ul>
						...
						<%-- <th><%=a+1%>.<%=i+1%>.1)</th> --%>
							...
							<th width="17%" style="text-align: right;">Add Question<sup>*</sup>
								...
								<span style="float: left; margin-left: 10px;"><input type="hidden" name="orientt" value="0"/><sup>*</sup>
								<input type="text" style="width: 35px!important;" name="weightage" id="weightage<%=counter %>" class="validateNumber" onkeypress="return isNumberKey(event)" value="<%=questionMpInnerList.get(1) %>" onkeyup="validateScoreEdit(this.value,'weightage<%=counter %>','hideweightage<%=counter %>','<%=CGMtotMQueWeight %>')"/>
								<input type="hidden" name="hideweightage" id="hideweightage<%=counter %>" value="<%=questionMpInnerList.get(1) %>" />
								</span>
								<span style="float: left; margin-left: 10px;"><a href="javascript:void(0)" title="Select from Question Bank" onclick="openQuestionBank('<%=counter %>');" > +Q </a></span>
								<span id="checkboxspan<%=counter %>" style="float: left; margin-left: 10px;">
									<input name="addFlag" type="checkbox" id="addFlag<%=counter %>" title="Add to Question Bank" <%if(questionMpInnerList.get(10) != null && uF.parseToBoolean(questionMpInnerList.get(10))){%> 
									 checked="checked" <%} %> onclick="changeStatus('<%=counter %>')"/>
								<input type="hidden" id="status<%=counter %>" name="status" value="<%=(questionMpInnerList.get(10) != null && uF.parseToBoolean(questionMpInnerList.get(10))) ? "1" : "0" %>"/></span>
								<%-- <a href="javascript:void(0)" class="add_lvl" title="Add New Question" onclick="getOtherquestion()" ></a>&nbsp;&nbsp;
								<img border="0" style="height: 16px; width: 16px;" src="<%=request.getContextPath()%>/images/close_pop.png" title="Remove Question" onclick="removeOtherquestion('otherQuestionUl<%=a %>_<%=i %>')"/> --%>
								<input type="hidden" name="questiontypename" value="0" /></td>
				...
				<li>
					 <table class="table table_no_border" style="width: 100%;">
						...
						<tr>
							...
							<td>
							<input type="text" name="scoreCardWeightage" id="scoreCardWeightage<%=counter %>" onkeypress="return isNumberKey(event)" class="validateNumber" value="<%=scoreInnerList.get(3)%>" onkeyup="validateScoreEdit(this.value,'scoreCardWeightage<%=counter %>','hidescoreCardWeightage<%=counter %>','<%=request.getAttribute("totWeightage") %>')"/>
							<input type="hidden" name="hidescoreCardWeightage" id="hidescoreCardWeightage<%=counter %>" value="<%=scoreInnerList.get(3)%>" />
							</td>
						</tr>
						<%-- <tr>
						...
						<li>
							 <table class="table table_no_border" style="width: 100%;">
								...
								<tr>
									<th style="text-align: right;">Weightage %<sup>*</sup></th>
									<td>
									<input type="text" name="measureWeightage" id="measureWeightage<%=counter %>" class="validateNumber" onkeypress="return isNumberKey(event)"  value="<%=measureMpInnerList.get(3)%>" onkeyup="validateScoreEdit(this.value,'measureWeightage<%=counter %>','hidemeasureWeightage<%=counter %>','<%=CMtotSMeasureWeight %>')"/>
							...
							<ul>
								...
								<%-- <th><%=a+1%>.<%=i+1%>.1)</th> --%>
									...
									<th width="17%" style="text-align: right;">Add Question<sup>*</sup>
										...
										<span style="float: left; margin-left: 10px;"><input type="hidden" name="orientt" value="0"/><sup>*</sup>
										<input type="text" style="width: 35px!important;" name="weightage" id="weightage<%=counter %>" class="validateNumber" value="<%=questionMpInnerList.get(1) %>" onkeypress="return isNumberKey(event)" onkeyup="validateScoreEdit(this.value,'weightage<%=counter %>','hideweightage<%=counter %>','<%=CMtotSQueWeight %>')"/>
										<input type="hidden" name="hideweightage" id="hideweightage<%=counter %>" value="<%=questionMpInnerList.get(1) %>" />
										</span>
										<span style="float: left; margin-left: 10px;"><a href="javascript:void(0)" title="Select from Question Bank" onclick="openQuestionBank('<%=counter %>');" > +Q </a></span>
										<span id="checkboxspan<%=counter %>" style="float: left; margin-left: 10px;">
					...
					<ul>
						...
						<%-- <th><%=a+1%>.<%=i+1%>.1)</th> --%>
							...
							<th width="17%" style="text-align: right;">Add Question<sup>*</sup>
								...
								<span style="float: left; margin-left: 10px;"><input type="hidden" name="orientt" value="0"/><sup>*</sup>
								<input type="text" style="width: 35px!important;" name="weightage" id="weightage<%=counter %>" class="validateNumber" onkeypress="return isNumberKey(event)" value="<%=questionMpInnerList.get(1) %>" onkeyup="validateScoreEdit(this.value,'weightage<%=counter %>','hideweightage<%=counter %>','<%=CMtotMQueWeight %>')"/>
								<input type="hidden" name="hideweightage" id="hideweightage<%=counter %>" value="<%=questionMpInnerList.get(1) %>" />
								</span>
								<span style="float: left; margin-left: 10px;"><a href="javascript:void(0)" title="Select from Question Bank" onclick="openQuestionBank('<%=counter %>');" > +Q </a></span>
								<span id="checkboxspan<%=counter %>" style="float: left; margin-left: 10px;">
			...
			<%
						...
						if (otherQuestionList!= null && otherQuestionList.size() > 0 && !otherQuestionList.isEmpty()) {
						Map<String, List<List<String>>> questionMp = otherQuestionList.get(0);
						if (questionMp != null && questionMp.size() >0 && !questionMp.isEmpty()) {
							Iterator<String> it = questionMp.keySet().iterator();
							while (it.hasNext()) {
								String key = it.next();
			...
			<ul class="">
				...
				<table class="table table_no_border" width="100%">
					...
					<tr id="shortdescTr<%=counter%>" style="display: none;"><th>&nbsp;</th><th style="text-align: right;">Short Description</th><td colspan="3"><input type="hidden" name="hideotherSD" id="hideotherSD<%=counter %>" value="f"/>
					...
					<%
						...
						<th></th><th></th><td>e)&nbsp;<input type="text" name="optione" value="<%=questionMpInnerList.get(6)%>"/> <input type="radio" name="correct<%=counter %>" value="e"
...
<%if(fromPage != null && fromPage.equals("SRR")) { %>
	...
	$("#formEditQuestionDetails").submit(function(event){
		...
		$.ajax({ 
			type : 'POST',
			url: "AddMyReviewEditQuestionDetails.action",
