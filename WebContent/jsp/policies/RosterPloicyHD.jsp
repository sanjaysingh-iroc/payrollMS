...
<div class="box-body">
	...
	<s:form theme="simple" action="RosterPolicyHD" method="POST" cssClass="formcss" id="formAddNewRow">
		...
		<table border="0" class="table">
			...
			<tr>
				<td class="txtlabel" colspan="2">Half day policy is applicable if:</td>
			</tr>
