...
<div class="aboveform">
<h4><%=(request.getParameter("E")!=null)?"Edit":"Add" %> Rates</h4>
...
<s:form name="frmRates" theme="simple" action="PayrollPolicy" method="POST" cssClass="formcss">
...
<!-- 
	...
	<s:select label="Select Employee" name="designation"
...
<tr>
	...
	<td class="label"><s:textfield cssStyle="width:100px" cssStyle="width:100px" name="monAmount" label="Monday" required="true" id="mon"/><span class="hint">Hourly rate for Monday. Specify the rate amount in numbers only, with two decimal points. Do not include a sign. For example: 10.00.<span class="hint-pointer">&nbsp;</span></span></td>
	<td class="label alignRight">Loading Amount:</td>
	<td class="label"><s:textfield cssStyle="width:100px" cssStyle="width:100px" name="monHolidayLoading" label="Amount" required="true" id="idMonHolidayLoading" /><span class="hint">Loading amount for Monday of an employee for any paycycle. Specify amount in %.<span class="hint-pointer">&nbsp;</span></span>%</td>
</tr>
