...
function submitForm(type){
	...
	$.ajax({
		type : 'POST',
		url: 'Form5.action?f_org='+org+paramValues,
...
function generateForm5() {
	...
	var url='ITFormReports.action?formType=form5&financialYear='+financialYear;
...
<!-- Custom form for adding new records -->
		...
		<div class="box-header with-border">
		    <h3 class="box-title">Form 5 for financial year <%=strFinancialYearStart1%> to <%=strFinancialYearEnd1%></h3>
		</div>
		<!-- /.box-header -->
		<div class="box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
			<div class="box box-primary collapsed-box" style="border-top-color: #EEEEEE;">
				...
				<div class="box-body" style="padding: 5px; overflow-y: auto; display: none;">
					<s:form name="frm_from5" action="Form5" theme="simple">
			...
			<!-- <div class="col-md-2" style="margin: 0px 0px 10px 0px; float: right;">
				<a onclick="generateForm5();" href="javascript:void(0)" class="fa fa-file-pdf-o"></a>
			</div>  -->
...
<a onclick="generateReportExcel();" href="javascript:void(0)" style="background-repeat: no-repeat;float: right;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
			 ...
			 <div style="float:left;width:30%">
				<div style="padding:12px;border:1px solid #ccc;margin-bottom:20px">	
					...
					<p style="font-size:13px;font-weight:normal;"><%=uF.showData(hmOrg.get("ORG_NAME"), "")%></p>
					<p style="font-size:13px;font-weight:normal;"><%=uF.showData(hmOrg.get("ORG_ADDRESS"), "")%></p>
				</div>
			...
			<div style="float:left;margin-left:20px;width:50%">
				<p style="font-size:13px;font-weight:bold;text-align:center">Form 5</p>
				<p style="font-size:12px;text-align:center">THE EMPLOYEES' PROVIDENT FUND SCHEME, 1952[PARA 36(2)(a)]</p>
				<p style="font-size:12px;text-align:center">AND THE EMPLOYEE PENSION SCHEME, 1995 [PARA 20(4)]</p>
				<p style="font-size:12px;text-align:center">Return of Employees qualifying for membership of the employee's Provident Fund,</p>
				<p style="font-size:12px;text-align:center">Employee's Pension Fund &amp; Employee's Deposit Linked Insurance Fund for the first time </p>
				<%if(strMonth!=null){ %>
				<p style="font-size:12px;text-align:center">during the month of <%=strMonth %> </p>
				<%} %>
				
				<p style="font-size:12px;font-weight:bold;text-align:center">[To be sent to the commissioner with Form 2 (EPF &amp; EPS)]</p>
			</div>		
			...
			<table width="100%" class="table table-bordered">
				...
				<tr>
					<td width="5%" align="center" class="reportHeading">Sr. No.<br/>(1)</td>
					<td width="10%" align="center" class="reportHeading">Account Number<br/>(2)</td>
					<td width="15%" align="center" class="reportHeading">Name of the Member<br/>(3)</td>
					<td width="15%" align="center" class="reportHeading">Father's Name (or Husband's Name in case of married woman)<br/>(4)</td>
					<td width="10%" align="center" class="reportHeading">Date of Birth<br/>(5)</td>
					<td width="5%" align="center" class="reportHeading">Sex<br/>(6)</td>
					<td width="10%" align="center" class="reportHeading">Date of joining the Fund<br/>(7)</td>
					<td width="20%" align="center" class="reportHeading">Date period of previous services as on the date of joining the Fund(enclose Scheme Certificate if applicable)<br/>(8)</td>
					<td width="10%" align="center" class="reportHeading">Remarks<br/>(9)</td>
				</tr>
				...
				<tr>
					...
					<td align="left" class="reportLabel"><%=uF.showData((String)alInner.get(0), "")%></td>
					<td align="left" class="reportLabel"><%=uF.showData((String)alInner.get(1), "")%></td>
					<td align="left" class="reportLabel"><%=uF.showData((String)alInner.get(2), "")%></td>
					...
					<td align="center" class="reportLabel"><%=uF.showData((String)alInner.get(6), "")%></td>
					<td align="left" class="reportLabel"><%=uF.showData((String)alInner.get(7), "")%></td>
				</tr>
				<%}if(alList.size()==0){ %>
				<tr>
					<td colspan="9"><div class="msg nodata"><span>No employees found</span></div></td>
				</tr>
				<%}%>
			</table>
