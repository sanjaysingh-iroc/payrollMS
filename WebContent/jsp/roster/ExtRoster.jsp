...
$(function(){
    ...
    function submitForm(type) {
    	...
    	var paramValues = "&operation=Submit";
    	if(type == '2') {
    		paramValues = '&operation=Submit&f_strWLocation='+f_strWLocation+'&f_department='+f_department+'&f_service='+f_service+'&f_level='+f_level+'&calendarYear='+calendarYear
    			+'&strMonth='+strMonth;
    	}
    	//alert("1 ===>> ");
    	...
    	$.ajax({
    		type : 'POST',
    		url: 'ExtRoster.action?f_org='+org+paramValues,
...
<%
    ...
    String strReportDateFormat = IConstants.DATE_FORMAT_STR;
	...
	<%StringBuilder sb = new StringBuilder(); %>
        <div class="box box-body" style="padding: 5px; overflow-y: auto; min-height: 600px;">
        <div class="box box-default collapsed-box" style="margin-bottom: 7px;"> <!--  collapsed-box -->
			...
			<div class="box-body" style="padding: 5px; overflow-y: auto;">
				<s:form theme="simple" action="ExtRoster" method="post" name="frm_roster_actual">
                                                ...
                                                <div style="height:30px; float:left; border:solid 1px #fff;" class="monthly_width">  <!-- style="width:1700px" -->
                                                    ...
                                                    <%
                                                        for (int k = 0; alDate != null && k < alDate.size(); k++) {
                                                        	...
                                                        	String strWeekDay = uF.getDateFormat((String)alDate.get(k),  strReportDateFormat, IConstants.DATE_FORMAT);
                                                        	if(strWeekDay!=null) {
                                                        	...
                                                        	if(strColour!=null) {
                                                       		...
                                                       		String strDay = uF.getDateFormat((String)alDate.get(k), strReportDateFormat, IConstants.DATE_FORMAT);
                                                        	...
                                                        	//String strLeaveCode = (String)hmLeaves.get(uF.getDateFormat((String)alDate.get(k), strReportDateFormat, IConstants.DATE_FORMAT));
                                                        	String strLeave = (String)hmLeaves.get(uF.getDateFormat((String)alDate.get(k), strReportDateFormat, IConstants.DATE_FORMAT));
                                                        	if(strLeave != null) {
                                                        		strColour = "#b5b5b5";
                                                        		leaveCnt++;
                                                        		strShiftName = "L";
                                                        	...
                                                        	String strCurrentDate = uF.getDateFormat(uF.getCurrentDate(strTimezone)+"", IConstants.DBDATE, strReportDateFormat);
